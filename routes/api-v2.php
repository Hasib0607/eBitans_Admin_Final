...
Route::group(['prefix' => 'v2'], function () {
    ...
    Route::get('/storefront/sitemap/{domain}', [StorefrontController::class, 'sitemap']);
    ...
    Route::get('/new-arrival-products/{store}', [SubdomainController::class, 'newArrivalProducts']);
    ...
    Route::get('/pse/product/search', [\App\Http\Controllers\Api\v2\ProductSearchController::class, 'search'])->middleware(['pse.domainCheck']);
