...
class AnalyticsController extends Controller
{
    ...
    public function salesStageFunnel(Request $request): JsonResponse
    {
        return $this->analyticsResponse('getSalesStageFunnelAnalytics', $request);
    }

    public function salesObjectionBreakdown(Request $request): JsonResponse
    {
        return $this->analyticsResponse('getSalesObjectionBreakdownAnalytics', $request);
    }

    public function salesCtaPerformance(Request $request): JsonResponse
    {
        return $this->analyticsResponse('getSalesCtaPerformanceAnalytics', $request);
    }

    public function salesOfferAnalytics(Request $request): JsonResponse
    {
        return $this->analyticsResponse('getSalesOfferAnalytics', $request);
    }

    public function followupTimingInsights(Request $request): JsonResponse
    {
        return $this->analyticsResponse('getFollowupTimingInsightsAnalytics', $request);
    }
}
