                                ...
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-end">
                                            <a href="{{ route('superadmin.store.category.create') }}"
                                            ...
                                            @if(isset($categories) && count($categories) > 0)
                                                @foreach($categories as $item)
                                                    <tr style="border-bottom:1px solid rgba(0, 0, 0, 0.125)">
                                                        ...
                                                        <td>
                                                            <img
                                                                src="{{URL::to('/')}}/assets/images/icon/{{$item->category_image}}"
                                                                alt="{{$item->category_name}}" width="40px">
                                                        </td>
                                                        <td>
                                                            @php
                                                        ...
                                                        <td>
                                                            <a href="{{ route('superadmin.store.edit.category', ['id' => $item->id]) }}"><img
                                                                    src="{{asset('img/edit.png')}}" width="20px"
                                                                    height="20px"></a>
                                                            &nbsp;&nbsp;
                                                            <a href="{{ route('superadmin.store.delete.category', ['id' => $item->id]) }}"
