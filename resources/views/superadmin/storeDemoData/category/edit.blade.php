                            ...
                            <div class="card h-100">
                                ...
                                <div class="card-body">
                                    <div class="row d-flex justify-content-center">
                                        <form action="{{ route("superadmin.store.update.category") }}" method="POST"
                                              class="col-md-6"
                                            ...
                                            <div class="mb-4">
                                                <label for="iconpack" class="form-label">Category Icon</label>
                                                <select id='iconpack' name="category_image" class="form-control">
                                                    <option value="">
                                                    ...
                                                    @if (isset($icons) && count($icons) > 0)
                                                        @foreach ($icons as $icon)
                                                            <option
                                                                value='{{ $icon->image }}'
                                                                {{ (isset($data->category_image) && $data->category_image == $icon->image) ? 'selected' : '' }}
                                                            >{{ $icon->name }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
