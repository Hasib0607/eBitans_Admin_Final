                                ...
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-end">
                                            <a href="{{ route('superadmin.store.theme.create') }}"
                                            ...
                                            @if(isset($themes) && count($themes) > 0)
                                                @foreach($themes as $item)
                                                    <tr style="border-bottom:1px solid rgba(0, 0, 0, 0.125)">
                                                        ...
                                                        <td>
                                                            <a href="{{ route('superadmin.store.edit.theme', ['id' => $item->id]) }}"><img
                                                                    src="{{asset('img/edit.png')}}" width="20px"
                                                                    height="20px"></a>
                                                            &nbsp;&nbsp;
                                                            <a href="{{ route('superadmin.store.delete.theme', ['id' => $item->id]) }}"
