                                ...
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-end">
                                            <a href="{{ route('superadmin.store.product.create') }}"
                                            ...
                                            @if(isset($products) && count($products) > 0)
                                                @foreach($products as $item)
                                                    <tr style="border-bottom:1px solid rgba(0, 0, 0, 0.125)">
                                                        ...
                                                        <td>
                                                            <img
                                                                src="{{URL::to('/')}}/assets/images/product/{{$item->product_image}}"
                                                                alt="{{$item->product_name}}" width="80px">
                                                        </td>
                                                        <td>
                                                            @php
                                                        ...
                                                        <td>
                                                            <a href="{{ route('superadmin.store.edit.product', ['id' => $item->id]) }}"><img
                                                                    src="{{asset('img/edit.png')}}" width="20px"
                                                                    height="20px"></a>
                                                            &nbsp;&nbsp;
                                                            <a href="{{ route('superadmin.store.delete.product', ['id' => $item->id]) }}"
