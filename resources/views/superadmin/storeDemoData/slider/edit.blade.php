                            ...
                            <div class="card h-100">
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-end">
                                            <a href="{{ route('superadmin.store.slider.list') }}"
                                ...
                                <div class="card-body">
                                    <div class="row d-flex justify-content-center">
                                        <form action="{{ route("superadmin.store.update.slider") }}" method="POST"
                                              class="col-md-6"
                                            ...
                                            <div class="mb-4">
                                                <img
                                                    src="{{URL::to('/')}}/assets/images/slider/{{$data->slider_image}}"
                                                    alt="" width="150px"
