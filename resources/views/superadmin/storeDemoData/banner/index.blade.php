                                ...
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-end">
                                            <a href="{{ route('superadmin.store.banner.create') }}"
                                            ...
                                            @if(isset($banners) && count($banners) > 0)
                                                @foreach($banners as $item)
                                                    <tr style="border-bottom:1px solid rgba(0, 0, 0, 0.125)">
                                                        ...
                                                        <td>
                                                            <img
                                                                src="{{URL::to('/')}}/assets/images/banner/{{$item->banner_image}}"
                                                                alt="" width="80px">
                                                        </td>
                                                        <td>
                                                            @php
                                                        ...
                                                        <td>
                                                            <a href="{{ route('superadmin.store.edit.banner', ['id' => $item->id]) }}"><img
                                                                    src="{{asset('img/edit.png')}}" width="20px"
                                                                    height="20px"></a>
                                                            &nbsp;&nbsp;
                                                            <a href="{{ route('superadmin.store.delete.banner', ['id' => $item->id]) }}"
