            ...
            <form action="{{ route('admin.updateproduct', $product->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-4">
                                            ...
                                            <input placeholder="" type="number" class="form-control" min="0" step="0.01"
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <select class="form-select" name="discount_type">
                                            ...
                                            <option value="no_discount" @if ($product->discount_type == 'no_discount')
                                                selected @endif>
                                                @if (Session::has('lang') && Session::get('lang') == 'bn')
                                                    নো
                                                    ডিসকাউন্ট
                        ...
                        <!-- <div class="card mb-4"onmouseover="mouseOverShipping()" onmouseout="mouseOverShippingmouseOut()">
                                                <div class="card-header" onmouseover="mouseOverShipping()"
                                                    onmouseout="mouseOverShippingmouseOut()" onclick="openShipping()">
                                                    <input type="hidden" id="shippingCheck" value="1">
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <h4>
                                                                @if (Session::has('lang') && Session::get('lang') == 'bn')
...
@if (Session::has('lang') && Session::get('lang') == 'bn')
                        ...
                        <select class="form-select" name="tax_type">
                            <option value="fixed" @if ($product->tax_type == 'fixed')
                            selected
                        ...
                        <option value="percent" @if ($product->tax_type == 'percent')
                            selected
...
@if (Session::has('lang') && Session::get('lang') == 'bn')
                                        ...
                                        @foreach ($images as $key => $image)
                                            <div class="oldImg-wrap">
                                                <img src="{{ $image }}"
                                                     ...
                                                     width="60px"
                                                     height="60px">
                                                <input type="hidden" class="form-control" id="" name="oldImage[]"
                                                       value="{{ $image }}">
                                            </div>
                                        @endforeach
                                    @endif
    ...
    @enderror
                            ...
                            <div class="card-body">
                                <div class="row gx-2">
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <select class="form-select" name="category" id="category">
                                            ...
                                            @foreach ($category as $cat)
                                                @isset($cat)
                                                    <option value="{{ $cat->id }}"
                                                            @if ($product->category == $cat->id) selected
                                                        @endif>{{ $cat->name }}
                                                    </option>
                                                @endif
                                            @endforeach
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select" name="brand" id="brand">
                                            ...
                                            @foreach ($brands as $brand)
                                                @isset($brand)
                                                    <option value="{{ $brand->id }}" @if (isset($product->brand) && $product->brand
                                            == $brand->id) selected @endif>{{ $brand->name }}
                                                    </option>
                                                @endif
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select" name="supplier" id="supplier">
                                            ...
                                            @foreach ($suppliers as $supplier)
                                                @isset($supplier)
                                                    <option value="{{ $supplier->id }}" @if (isset($product->supplier) &&
                                            $product->supplier == $supplier->id) selected @endif>
                                                        {{ $supplier->name }}
                                                    </option>
                                                @endif
                                            @endforeach
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" data-role="tagsinput" name="tagssD"
                                               value="{{ $product->tags }}" placeholder="Enter a comma after each
                                                        tag">
                                    ...
                                    <div class="mb-2">
                                        <label for="best_sell" class="form-label">
                                            <input type="checkbox" id="best_sell" name="best_sell" @if ($product->best_sell
                                        == 1) checked @endif>&nbsp;&nbsp;Best
                                            Sell</label>
                                    ...
                                    <div class="mb-2">
                                        <label for="pse" class="form-label">
                                            <input type="checkbox" id="pse" name="pse" value="1"
                                                   @if ($product->pse == 1 || $product->pse == 2)
                                                       checked @endif>&nbsp;&nbsp;Show PSE List @if ($product->pse == 1)
                        ...
                        ?>
                    <div class="col-lg-9">
                        <div class="card mb-4" onmouseover="mouseOverVariant()" onmouseout="mouseOverVariantmouseOut()">
                                ...
                                <div class="row" id="attri-div">
                                    <div class="col-md-2">
                                        ...
                                        <select class="form-control" name="att" id="attributes">
                                            ...
                                            <option value="color" @if (isset($attri_color) && count($attri_color)> 0)
                                                selected @endif>
                                                Color & Size
                                            </option>
                                            <option value="onlycolor" @if (isset($select_onlycolor) &&
                                            count($select_onlycolor)> 0) selected @endif>
                                                Color
                                            </option>
                                            <option value="unit"
                                                    @if (isset($select_unitsss) && count($select_unitsss)> 0)
                                                        selected @endif>Unit
                                            </option>
                                            <option value="size" @if (isset($select_sizess) && count($select_sizess)> 0)
                                                selected @endif>Size
                                            </option>
                                        </select>
                                    </div>
                                                        ...
                                                        <tr id="{{ $colorsss->id }}">
                                                                ...
                                                                <select name="color[]" id="color" class="form-control"
                                                                    ...
                                                                    @if (isset($colors))
                                                                        @foreach ($colors as $cl)
                                                                            <option value="{{ $cl->code }}" @if ($colorsss->color ==
                                                                $cl->code) selected @endif>
                                                                                {{ $cl->name }}</option>
                                                                        @endforeach
                                                                    @endif
                                                                </select>
                                                            ...
                                                            <td class="mt-1" style="text-align:center">
                                                                <div class="col-md-1 mt-1" hidden>
                                                                    <input type="checkbox" name="sid[{{ $keyss }}][]"
                                                                           checked>
                                                                </div>
                                                                <select name="size[{{ $keyss }}][]" id="sizs"
                                                                    ...
                                                                    @if (isset($size))
                                                                        @foreach ($size as $key => $sz)
                                                                            <option value="{{ $sz->name }}" @if ($colorsss->size ==
                                                                $sz->name) selected @endif>
                                                                                {{ $sz->name }}</option>
                                                                        @endforeach
                                                                    @endif
                                                                </select>
                                                            ...
                                                            <td class="mt-1" style="text-align:center">
                                                                <input type="number" name="quantitys[{{ $keyss }}][]"
                                                                       id="qunty"
                                                                       class="form-control"
                                                            ...
                                                            <td class="mt-1" style="text-align:center"><input
                                                                    type="number"
                                                                    name="price[{{ $keyss }}][]" id="additionalpricess"
                                            ...
                                            <div class="table-responsive">
                                                <table class="colorrss_ok table table-stripped" width="100%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th width="25%" style="text-align:center">Additional Price
                                                        </th>
                                                    ...
                                                    @foreach ($attri_sizess as $sizesss)
                                                        <tr>
                                                            <td class="mt-1" style="text-align:center">
                                                                <select name="sizess[]" id="" class="form-control"
                                                                        step="any">
                                                                        <?php
                                                                        $size = DB::table('sizes')
                                                                            ->where('store_id', $store_id)
                                                                    ...
                                                                    @if (isset($size))
                                                                        @foreach ($size as $key => $sz)
                                                                            <option value="{{ $sz->name }}" @if ($sizesss->size ==
                                                                $sz->name) selected @endif>
                                                                                {{ $sz->name }}</option>
                                                                        @endforeach
                                                                    @endif
                                                            ...
                                                            <td class="mt-1" style="text-align:center"><input
                                                                    type="number"
                                                                    name="quantityss[]" id="" class="form-control"
                                                                    value="{{ $sizesss->quantity }}"></td>
                                                            <input type="hidden" name="attriid" id="attriid"
                                                                   value="{{ $sizesss->id }}">
                                                            <td class="mt-1" style="text-align:center"><input
                                                                    type="number"
                                                                    name="pricess[]" id="" class="form-control" min="0"
                                                                    step="0.01"
                                                ...
                                                @foreach ($attri_onlycolor as $colorssss)
                                                    <tr>
                                                        <td style="text-align:center">
                                                            <select name="colors[]" id="color" class="form-control"
                                                                    step="any">
                                                                    <?php
                                                                    $colors = DB::table('colors')
                                                                        ->where('store_id', $store_id)
                                                                ...
                                                                @if (isset($colors))
                                                                    @foreach ($colors as $cl)
                                                                        <option value="{{ $cl->code }}" @if ($cl->code ==
                                                            $colorssss->color) selected @endif>
                                                                            {{ $cl->name }}</option>
                                                                    @endforeach
                                                                @endif
                                                            </select>
                                                        ...
                                                        <td style="text-align:center">
                                                            <input type="number" name="quantitysss[]" id=""
                                                                   class="form-control"
                                                                   min="0" value="{{ $colorssss->quantity }}">
                                                        </td>
                                                        <input type="hidden" name="attriid" id="attriid"
                                                               value="{{ $colorssss->id }}">
                                                        <td style="text-align:center">
                                                            <input type="number" name="pricesss[]" id=""
                                                                   class="form-control"
                                            ...
                                            <tr id="new3" style="margin-top:5px;">
                                                <td>
                                                    ...
                                                    <div class="row" style="margin-top:5px;">
                                                        ...
                                                        <div class="col-md-3">
                                                            <input type="number" class="form-control" name="pricesss[]"
                                                                   placeholder="Enter Price" min="0" step="0.01"
                                                                   value="">
                                                        </div>
                                                        <div class="col-md-3">

                                                            <a class="btn p-1" onclick="addOnlycolor()">
                                                                <img src="{{ URL::to('/') }}/img/add.png" alt=""
                                                                     width="30px">
                                                            </a>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="mt-1">
                                                                <select name="unit[]" id="" class="form-control"
                                                                    ...
                                                                    @if (isset($color))
                                                                        @foreach ($color as $cl)
                                                                            <option value="{{ $cl->name }}" @if ($unitssss->unit ==
                                                                $cl->name) selected @endif>
                                                                                {{ $cl->name }}</option>
                                                                        @endforeach
                                                                    @endif
                                                                </select>
                                                            ...
                                                            <td class="mt-1" style="text-align:center">
                                                                <input type="number" name="Uquantitys[]" id=""
                                                                       class="form-control"
                                                            ...
                                                            <td class="mt-1" style="text-align:center"><input
                                                                    type="number"
                                                                    name="Uprice[]" id="" class="form-control" min="0"
                                                                    step="0.01"
                                                ...
                                                <tr id="new1" style="margin-top:5px;">
                                                    ...
                                                    <td>
                                                        <div class="row" style="margin-top:5px;">
                                                            <div class="col-md-3 mt-1">
                                                                <input type="number" class="form-control"
                                                                       name="volume[]" value="" placeholder="Volume">
                                                            </div>
                                                            <div class="col-md-3 mt-1">
                                                                <select name="unit[]" id="color" class="form-control"
                                                                        step="any">
                                                            ...
                                                            <div class="col-md-3 mt-1">
                                                                <input type="number" class="form-control"
                                                                       name="Uquantitys[]" placeholder="Enter Quantity"
                                                                       value="">
                                                            </div>
                                                            <div class="col-md-3 mt-1">
                                                                <input type="number" class="form-control" min="0"
                                                                       step="0.01"
                                                                       name="Uprice[]" placeholder="Enter Price"
                                                                       value="">
                                                            </div>
                                                        </div>
                                                    </td>
                        ...
                        <a href="{{ URL::to('/') }}/superadmin/pse-products/accepted?id={{ $product->id }}"
                           class="btn btn-success rounded font-sm hover-up">Accepte</a>
                        <a href="{{ URL::to('/') }}/superadmin/pse-products/rejected?id={{ $product->id }}"
                           class="btn btn-info rounded font-sm hover-up">Reject</a>
...
@push('scripts')
        ...
        function ApplyFileValidationRules(readerEvt) {
            ...
            if (CheckFileSize(readerEvt.size) == false) {
                ...
                swal.fire(
                    ...
                    "The file (" +
                    readerEvt.name +
                    ") does not match the upload conditions, The maximum file size for uploads should not exceed 200 KB 🥱",
                    'error'
                );
                e.preventDefault();
                return;
        ...
        function addRow(i) {
            ...
            sizes.forEach(function (data) {
                ...
                size += ` <div class="row" style="margin-top:5px;">
                                                            ...
                                                            <div class="col-md-3">
                                                                <input type="text" class="form-control" name="size[` + i + `][]" value="` +
                    data.name +
                    `" readonly>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <input type="number" class="form-control"  id="checkBoxWrite` + p + `" readonly name="quantitys[` + i + `][]" placeholder="Enter Quantity">
                                                            </div>
                                                            <div class="col-md-4">
                                                            <input type="number" class="form-control" min="0" step="0.01" name="price[` + i + `][]" placeholder="Enter Price">
                                                            </div>
                                                        </div>`;
                j++;
            ...
            var col = `<tr id="new" style="margin-top:5px;">
                                                ...
                                                <td>
                                                <label>Color:</label>
                                                    <select name="color[]" id="color" class="form-control" step="any">
    ...
    <script>
        function changeVarient(l) {
            ...
            swal.fire({
                title: 'আপনি ভেরিয়েন্ট পরিবর্তন করতে চাচ্ছেন?',
                text: "আপনি ভ্যারিয়েন্ট পরিবর্তন করলে, যদি আগে কোনো ভেরিয়েন্ট অ্যাড করে থাকেন সেটি ডিলিট হয়ে যাবে।",
