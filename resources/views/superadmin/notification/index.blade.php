    ...
    <main class="main-content position-relative h-100 border-radius-lg" id="admin-socket-notification">
        ...
        <div class="container-fluid mt-4" id="toplist">
            <div class="row">
                ...
                <div class="col-md-6">
                    <ul>
                        <li style="padding:0px;border:0px;"><a href="{{route('notification.create')}}"
                            ...
                            <div class="row">
                                <div class="col-md-3" style="padding-right:1px;">
                                    <form class="row" method="post"
                                          action="{{route('superadmin.changenotificationstatus')}}">
                                        @csrf
                                        <div class="col-6">
                                    ...
                                    @if(isset($notification) && count($notification)>0)
                                        @foreach($notification as $key=>$notifications)
                                            <tr style="border-bottom:1px solid rgba(0, 0, 0, 0.125)">
                                                ...
                                                <td>{{$notifications->user_type}}</td>
                                                <td>
                                                    <a href="{{route('notification.edit',$notifications->id)}}"><img
                                                            src="{{asset('img/edit.png')}}" width="20px" height="20px"></a>
                                                    &nbsp;&nbsp;
                                                    <a href="{{route('notification.delete',$notifications->id)}}"
