                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" name="user_type" id="user_type">
                                            <option value="all"
                                                    @if($notification->user_type=='all') selected @endif>All
                                            </option>
                                            <option value="admin"
                                                    @if($notification->user_type=='admin') selected @endif>Admin
                                            </option>
                                            <option value="staff"
                                                    @if($notification->user_type=='staff') selected @endif>Staff
                                            </option>
                                            <option value="dropshipper"
                                                    @if($notification->user_type=='dropshipper') selected @endif>
                                                Dropshipper
                                            </option>
                                            <option value="affiliate"
                                                    @if($notification->user_type=='affiliate') selected @endif>Affiliate
                                            </option>
                                            <option value="superstaff"
                                                    @if($notification->user_type=='superstaff') selected @endif>Super
                                                Admin Staff
                                            </option>
                                        </select>
                                        @error('user_type')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" placeholder="Type here" class="form-control" id="title"
                                               name="title" value="{{$notification->title ?? old('title')}}"
                                               required>
                                        @error('title')
                                        <p class="text-danger" role="alert">{{$message}}</p>
                                        @enderror
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" placeholder="Type here" class="form-control" id="link"
                                               name="link" value="{{$notification->link ?? ''}}">
                                        @error('link')
                                        <p class="text-danger" role="alert">{{$message}}</p>
                                        @enderror
                                    </div>
