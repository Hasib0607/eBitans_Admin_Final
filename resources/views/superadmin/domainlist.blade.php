                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-2" style="padding-right:1px;">
                                    <form method="post" action="{{route('superadmin.deletealldomain')}}">
                                        @csrf
                                    ...
                                    @if(isset($domain) && count($domain)>0)
                                        @foreach($domain as $dm)
                                            <tr style="border-bottom:1px solid rgba(0, 0, 0, 0.125)">
                                                <td><input type="checkbox" name="selectedid" value="{{$dm->id}}" id="id"
                                                ...
                                                <td>
                                                    <a href="{{route('superadmin.domain.delete',$dm->id)}}"
                                                       onclick="return confirm('Are you sure, you want to Delete this domain?')"
                                                       class="btn btn-primary" style="margin-bottom:0px !important;">Delete</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
