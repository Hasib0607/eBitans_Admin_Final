                ...
                <div class="col-md-6">
                    <ul>
                        <li style="padding:0px;border:0px;">
                            <a href="{{ route('affiliate.faq.question.create') }}" class="btn btn-primary"
                            ...
                            <div class="row">
                                <div class="col-md-2" style="padding-right:1px;">
                                    <form id="submitform" method="post"
                                          action="{{ route('affiliate.faq.question.action') }}">
                                        @csrf
                                ...
                                <table class="table table-striped" id="taskfilterresult" width="100%">
                                    ...
                                    @foreach ($faqs as $item)
                                        <tr style="border-bottom:1px solid rgba(0, 0, 0, 0.125)">
                                            ...
                                            <td>
                                                <a href="{{ route('affiliate.faq.question.edit', $item->id) }}">
                                                    <img src="{{ asset('img/edit.png') }}" width="20px"
                                                         height="20px">
                                                </a>
                                                &nbsp;&nbsp;
                                                <a href="{{ route('affiliate.faq.question.delete', $item->id) }}"
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            function handleStatusChange(element) {
                ...
                sendAjaxRequest('{{ route('affiliate.faq.question.status') }}', {
                    value: value,
                    id: id
                });
            }
