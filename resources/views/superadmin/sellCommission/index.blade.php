...
@section('content')
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        @include('superadmin.sellCommission.top_nav_menu')
                ...
                <div class="col-12">
                    <div class="card mb-5">
                        <div class="card-header">
                            <div class="row">
                                <form action="{{ route('superadmin.sell.commission') }}" method="get"
                                      class="row">
                                    <div class="col-md-2">
                                    ...
                                    @if(count($stores))
                                        @foreach ($stores as $key => $store)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('superadmin.sell.order.details', ['id' => $store->id]) }}"
...
@push('scripts')
    ...
    <script>
        function okComment(id) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('superadmin.update.sell.commission') }}",
                data: {
                    id: id,
                    commission: text
                },
        ...
        const pullCommission = (id) => {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('superadmin.update.sell.order.pull') }}",
                data: {
                    id: id,
        ...
        const overFlowCommission = (id) => {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('superadmin.update.sell.order.overflow.commission') }}",
                data: {
                    id: id,
