...
<div class="p-4">
    <div class="row mb-4 mt-5">
        <div class="col-lg-3 col-md-6 col-sm-6">
            <a href="{{ route('super.admin.ebitans.analytics.all.traffic') }}" target="_blank" rel="noopener noreferrer">
                <div class="card  mb-2">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1">
                            <p class="text-sm mb-0 text-capitalize">Total Traffic</p>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 mt-sm-0 mt-4">
            <div class="card  mb-2">
                <div class="card-header p-3 pt-2">
                    ...
                    <div class="text-end pt-1">
                        <p class="text-sm mb-0 text-capitalize">Total PC Traffic</p>
                        <h4 class="mb-0">{{ $totalPc }}</h4>
                    </div>
                </div>
                <hr class="dark horizontal my-0">
                <div class="card-footer p-3">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 mt-lg-0 mt-4">
            <div class="card  mb-2">
                <div class="card-header p-3 pt-2 bg-transparent">
                    ...
                    <div class="text-end pt-1">
                        <p class="text-sm mb-0 text-capitalize ">Total Mobile Traffic</p>
                        <h4 class="mb-0 ">{{ $totalMobile }}</h4>
                    </div>
                </div>
                <hr class="horizontal my-0 dark">
                <div class="card-footer p-3">
                    <p class="mb-0 "><span class="text-success text-sm font-weight-bolder">+1% </span>than yesterday
                    </p>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-6 col-sm-6 mt-lg-0 mt-4">
            <div class="card ">
                <div class="card-header p-3 pt-2 bg-transparent">
                    ...
                    <div class="text-end pt-1">
                        <p class="text-sm mb-0 text-capitalize ">Ebitans Traffic</p>
                        <h4 class="mb-0 ">{{ $totalEbi }}</h4>
                    </div>
                </div>
                <hr class="horizontal my-0 dark">
                <div class="card-footer p-3">
    ...
    <div class="col-lg-12 position-relative z-index-2 mt-3 mb-4">
        <div class="card mb-4 ">
            <div class="d-flex">
                <div class="icon icon-shape icon-lg bg-gradient-success shadow text-center border-radius-xl mt-n3 ms-4">
                    <i class="material-icons opacity-10" aria-hidden="true">language</i>
                </div>
                <h6 class="mt-3 mb-2 ms-3 ">Visit by <a href="#"> Total Country: {{ $country_infos->count() }}
                    </a></h6>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-7">
                        <div class="table-responsive">
                            <h6 class="text-center"> <u>Top 4 Country</u> </h6>
                            <table class="table align-items-center ">
                                <tbody>
                                    @foreach ($country_infos->take(4) as $country)
                                        <tr>
                                            <td class="w-30">
                                                <div class="d-flex px-2 py-1 align-items-center">
                                                    <div>
                                                        <img style="width: 100%;"
                                                            src="https://dyclassroom.com/image/flags/{{ strtolower($country->country_code) }}.png"
                                                            onerror="this.src='https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/Unknown_flag_-_European_version.png/800px-Unknown_flag_-_European_version.png?20150805095502';">
                                                    </div>
                                                    <div class="ms-4">
                                                        <p class="text-xs font-weight-bold mb-0 ">Country:</p>
                                                        <h6 class="text-sm font-weight-normal mb-0 ">
                                                            {{ $country->country_name ?? 'Unknown' }}</h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="text-center">
                                                    <p class="text-xs font-weight-bold mb-0 ">Visitor:</p>
                                                    <h6 class="text-sm font-weight-normal mb-0 ">
                                                        {{ $country->totalCountry }}</h6>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
                    ...
                    <div class="col-lg-8 col-md-5">
                        <div id="map" class="mt-0 mt-lg-n4 jvm-container"><svg width="776" height="259">
                                <defs></defs>
                                <g id="jvm-regions-group"
                                    transform="scale(0.4441927145890737) translate(423.4947405856081, 0)">
                                    <path
                                    ...
                                    <path
                                        ...
                                        stroke-width="0" fill-rule="evenodd" class="jvm-region jvm-element"></path>
                                    <path d="M734.55,437.87l-0.09,-0.98l4.5,-0.86l-2.82,1.28l-1.59,0.55Z"
                                    ...
                                    <path
                                        ...
                                        stroke-width="0" fill-rule="evenodd" class="jvm-region jvm-element"></path>
                                    <path d="M448.79,409.52l0.02,2.22l-4.09,0.0l0.69,-2.27l3.38,0.05Z" data-code="GQ"
                                        fill="#dee2e8" fill-opacity="1" stroke="none" stroke-width="0"
                                        fill-rule="evenodd" class="jvm-region jvm-element"></path>
                                    <path
                                    ...
                                    <path
                                        ...
                                        stroke-width="0" fill-rule="evenodd" class="jvm-region jvm-element"></path>
                                    <path d="M256.17,368.34l-0.27,0.28l-2.83,0.06l-0.07,-0.57l1.95,-0.1l1.23,0.34Z"
                                    ...
                                    <path
                                        ...
                                        stroke-width="0" fill-rule="evenodd" class="jvm-region jvm-element"></path>
                                    <path d="M839.03,452.86l0.23,1.16l-0.44,0.03l-0.2,-1.47l0.42,0.28Z" data-code="VU"
                                        fill="#dee2e8" fill-opacity="1" stroke="none" stroke-width="0"
                                        fill-rule="evenodd" class="jvm-region jvm-element"></path>
                                    <path d="M838.79,471.67l-0.34,0.23l-2.9,-1.8l-3.27,-3.48l1.65,0.85l4.86,4.19Z"
                                    ...
                                    <path
                                        ...
                                        stroke-width="0" fill-rule="evenodd" class="jvm-region jvm-element"></path>
                                    <path d="M504.35,321.02l0.49,0.34l-1.34,0.65l-0.91,-0.29l-0.26,-0.55l2.02,-0.14Z"
                                    ...
                                    <path d="M266.64,389.17l0.28,-1.17l1.13,-0.22l-0.06,1.21l-1.35,0.18Z"
                                ...
                                <g id="jvm-markers-group">
                                    <circle data-index="0" cx="292.7847921194732" cy="134.5871942936338"
                                        r="7" fill="#e91e63" fill-opacity="1" stroke="#FFF"
                                        stroke-width="5" stroke-opacity="0.5" class="jvm-marker jvm-element">
                                    </circle>
                                    <circle data-index="1" cx="387.3098108141878" cy="117.77618111649691"
                                        r="7" fill="E91E63" fill-opacity="1" stroke="#FFF"
                                        stroke-width="5" stroke-opacity="0.5" class="jvm-marker jvm-element">
                                    </circle>
                                    <circle data-index="2" cx="314.1656116628319" cy="192.7213602474008"
                                        r="7" fill="#e91e63" fill-opacity="1" stroke="#FFF"
                                        stroke-width="5" stroke-opacity="0.5" class="jvm-marker jvm-element">
                                    </circle>
                                    <circle data-index="3" cx="474.99694294756017" cy="94.97112314618349"
                                        r="7" fill="E91E63" fill-opacity="1" stroke="#FFF"
                                        stroke-width="5" stroke-opacity="0.5" class="jvm-marker jvm-element">
                                    </circle>
                                    <circle data-index="4" cx="502.0873592374049" cy="158.76794844934062"
                                        r="7" fill="#E91E63" fill-opacity="1" stroke="#FFF"
                                        stroke-width="5" stroke-opacity="0.5" class="jvm-marker jvm-element">
                                    </circle>
                                </g>
    ...
    <div class="col-lg-12 position-relative z-index-2">
        <div class="card mb-4 ">
            <div class="d-flex">
                ...
                <h6 class="mt-3 mb-2 ms-3 ">Vistor by State </h6>
            </div>
            <div class="card-body p-3">
                <div class="row">
                    <div class="col-lg-8 col-md-5">
                        <div id="map" class="mt-0 mt-lg-n4 jvm-container"><svg width="776"
                                height="259">
                                <defs></defs>
                                <g id="jvm-regions-group"
                                    transform="scale(0.4441927145890737) translate(423.4947405856081, 0)">
                    ...
                    <div class="col-lg-4 col-md-7">
                        <div class="table-responsive">
                            <h6 class="text-center"> <u>Top 4 State</u> </h6>
                            <table class="table align-items-center ">
                                <tbody>
                                    @foreach ($state_infos->take(4) as $state)
                                        <tr>
                                            <td class="w-30">
                                                <div class="d-flex px-2 py-1 align-items-center">
                                                    {{-- <div style="width: 12%;">
                                                    ...
                                                    <div class="ms-4">
                                                        ...
                                                        <h6 class="text-sm font-weight-normal mb-0 ">
                                                            {{ $state->state == 'null' ? $state->country_name : $state->state }}
                                                        </h6>
                                                    </div>
                                                </div>
                                            </td>
    ...
    <div class="row">
            ...
            <div class="card h-100">
                <div class="card-header pb-0 p-3">
                    <div class="d-flex align-items-center">
                        <h6 class="mb-0">Oparating System</h6>
                        <button type="button"
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-12 text-center">
                            <div class="chart mt-5">
                                <canvas id="chart-doughnut" class="chart-canvas" height="200" width="245"
                                    style="display: block; box-sizing: border-box; height: 200px; width: 245.8px;"></canvas>
                            </div>
                            <a class="btn btn-sm bg-gradient-secondary mt-4">See all oparating system</a>
                        </div>
                        <div class="col-lg-7 col-12">
                            <div class="table-responsive">
                                <table class="table align-items-center mb-0">
                                    <tbody>
                                        @php
                                            $colors = ['#2152ff', '#3A416F', '#f53939', '#005a14', '#e91e63', '#00c12b', '#96a102', '', '', '', '', '', '', '', '', '', '', ''];
                                            $data = [];
                                            $osName = ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''];
                                        @endphp
                                        @foreach ($os_infos as $key => $os)
                                            <tr>
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <h6 class="mb-0 text-sm">
                                                                <div
                                                                    style="width: 10px; height: 10px; background: {{ $colors[$key] }};    display: inline-block;">
                                                                </div> {{ $os->os ?? 'Unknown' }}
                                                            </h6>
                                                        </div>
                                                    </div>
                                                ...
                                                <td class="align-middle text-center text-sm">
                                                    @php
                                                        $value = floor(100 * $os->totalDevices) / $totalUsers;
                                                        $data[$key] = $value;
                                                        $osName[$key] = $os->os ?? 'Unknown';
                                                    @endphp
                                                    <span class="text-xs font-weight-bold"> {{ round($value, 2) }}
                                                        %</span>
                                                </td>
                                            </tr>
                                        @endforeach
                                        @php
                                            $colors1 = json_encode($colors);
                                            $osData = json_encode($data);
                                            $osName1 = json_encode($osName);
                                        @endphp
                                    </tbody>
                                </table>
                            </div>
        ...
        <div class="col-lg-7 col-md-12">
            <div class="card">
                <div class="card-header pb-0 p-3">
                    <h6 class="mb-0">Oparating system traffic channels</h6>
                    <div class="d-flex align-items-center">
                        @foreach ($os_infos as $key => $os)
                ...
                <div class="card-body p-3">
                    <div class="chart">
                        <canvas id="chart-line" class="chart-canvas" height="300" width="895"
                            style="display: block; box-sizing: border-box; height: 300px; width: 895.4px;"></canvas>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row mt-4">
        <div class="col-lg-7 col-md-12">
            <div class="card">
                ...
                <div class="card-body p-3">
                    <div class="chart">
                        <canvas id="chart-line2" class="chart-canvas" height="300" width="895"
                            style="display: block; box-sizing: border-box; height: 300px; width: 895.4px;"></canvas>
                    </div>
                </div>
            </div>
            ...
            <div class="card h-100">
                ...
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-lg-5 col-12 text-center">
                            <div class="chart mt-5">
                                <canvas id="chart-doughnut2" class="chart-canvas" height="200" width="245"
                                    style="display: block; box-sizing: border-box; height: 200px; width: 245.8px;"></canvas>
                            </div>
                                ...
                                <table class="table align-items-center mb-0">
                                    <tbody>
                                        @php
                                            ...
                                            $browserName = [];
                                        @endphp
                                        @foreach ($browser_infos as $key => $browsers)
                                            <tr>
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        <div class="d-flex flex-column justify-content-center">
                                                ...
                                                <td class="align-middle text-center text-sm">
                                                    @php
                                                        $value = floor(100 * $browsers->totalBrowser) / $totalUsers;
                                                        $data[$key] = (int) $value;

                                                        $browserName[$key] = $browsers->browser;
                                                    @endphp
                                                    <span class="text-xs font-weight-bold"> {{ round($value, 2) }}
                                                        %</span>
                                                </td>
                                        ...
                                        @php
                                            ...
                                            $browserName = json_encode($browserName);
                                        @endphp
                                    </tbody>
                                </table>
                            </div>
            ...
            <div class="card h-100 mt-4 mt-md-0">
                ...
                <div class="card-body px-3 pt-0 pb-2">
                    <div class="table-responsive p-0">
                        <h6 class="text-center"> <u>Top 10 visited link</u> </h6>
                        <table class="table align-items-center justify-content-center mb-0">
                            ...
                            <tbody>
                                @foreach ($url_infos->take(10) as $key => $url)
                                    <tr>
                                        <td>
                                            <p class="text-sm font-weight-normal mb-0">
                                                {{ $key + 1 }}. <a href="{{ $url->url }}" target="_blank"
                                        ...
                                        <td>
                                            <p class="text-sm font-weight-normal mb-0">{{ round($url->isTime/60, 2) }} min</p>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
...
@endsection
@push('scripts')
    <script src="{{ asset('analytics/beacon.min.js') }}"></script>
    <script src="{{ asset('analytics/jkanban.js') }}"></script>
    <script src="{{ asset('analytics/chartjs.min.js') }}"></script>
    <script>
        ...
        new Chart(ctx1, {
            ...
            data: {
                ...
                datasets: [{
                        ...
                        data: [1, 10, 30, 5, 60, 10, 190, 130, 100],
                        maxBarThickness: 6
                    },
                    {
                        label: "{{ $osName[1] }}'",
                        ...
                        data: [60, 10, 500, 40, 100, 600, 10, 80, 124],
                        maxBarThickness: 6
                    },
                    {
                        label: "{{ $osName[2] }}'",
                        ...
                        borderWidth: 3,
                        backgroundColor: gradientStroke2,
                        data: [400, 10, 100, 21, 98, 13, 956, 136, 200],
                        maxBarThickness: 6
                    },
                    {
                        label: "{{ $osName[3] }}'",
                    ...
                    },
                    {
                        ...
                        borderWidth: 3,
                        backgroundColor: gradientStroke2,
                        data: [96, 81, 70, 864, 30, 13, 956, 130, 9],
                        maxBarThickness: 6
                    },
                    {
                        label: "{{ $osName[5] }}'",
                        ...
                        borderWidth: 3,
                        backgroundColor: gradientStroke2,
                        data: [15, 260, 90, 21, 800, 13, 17, 82, 33],
                        maxBarThickness: 6
                    },
                ],
            },
    ...
    <script>
        ...
        new Chart(ctx2, {
            type: "doughnut",
            data: {
                labels: ['Android', 'iOS', 'Linux', 'MacOS', 'Unknown', 'Windows'],
                datasets: [{
                    label: "Oparation Systems",
                    weight: 15,
                    cutout: 60,
                    ...
                    pointRadius: 2,
                    borderWidth: 2,
                    backgroundColor: ['#2152ff', '#3A416F', '#f53939', '#005a14', '#e91e63', '#00c12b'],
                    data: {!! $data !!},
                    fill: false
                }],
            },
    ...
    <script>
        window.onload = function() {
            var latlng = new google.maps.LatLng(23.7591, 90.4003);
