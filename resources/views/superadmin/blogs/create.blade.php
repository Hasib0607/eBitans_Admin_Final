...
@section('content')
    ...
    <main class="main-content position-relative h-100 border-radius-lg">
        ...
        <section class="container content-main">
            <div class="row">
                <form action="{{ route('superadmin.blog.store') }}" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="{{ $editBlog->id ?? null }}">
                    @csrf
                    <div class="row">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-5 mt-4">
                                            ...
                                            <div id="thumbnailPreviewContainer"
                                                 ...
                                                 style="width: 1200px;height: 100px;max-width: 100%;">
                                        ...
                                        <div class="col-md-5 mt-4">
                                            ...
                                            <!-- Image preview container -->
                                            <div class="preview-container image-preview-container"
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <div class="row gx-2">
                                                        <select class="form-control" id="website" name="website">
                                                            <option value="0" selected>eBitans.com</option>
                                                            <option value="1">eBitans.com.bd</option>
                                                        </select>
                                                        @error('website')
                                                        <p class="text-danger" role="alert">{{ $message }}</p>
                                                        @enderror
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" value="{{ old('seo') }}" class="form-control"
                                                   id="blog_keyword" data-role="tagsinput" name="seo"
