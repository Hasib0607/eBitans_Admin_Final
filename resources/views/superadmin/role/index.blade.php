            ...
            <div class="row mt-5 productlist">
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{route('superadmin.saverole')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3 row">
                        ...
                        <div class="card-header">
                            ...
                            <div class="row">
                                <div class="col-md-2" style="padding-right:1px;">
                                    <form method="post" action="{{route('superadmin.changerolessstatus')}}">
                                        @csrf
                                ...
                                <table class="table" width="100%" id="taskfilterresult">
                                    ...
                                    @foreach($roles as $role)
                                        <tr style="border-bottom:1px solid rgba(0, 0, 0, 0.125)">
                                            <td><input type="checkbox" name="selectedid" value="{{$role->id}}" id="id"
                                            ...
                                            <td>
                                                ...
                                                <a href="{{URL::to('/')}}/superadmin/role/permission/{{encrypt($role->id)}}/permission"
