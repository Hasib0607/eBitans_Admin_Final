...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
        <form id="productupdate" action="{{route('admin.campaign.productupdate',$campaign->id)}}" method="post" enctype="multipart/form-data">
                @csrf
...
<div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
        <form id="categoryupdate" action="{{route('admin.campaign.categoryupdate',$campaign->id)}}" method="post" enctype="multipart/form-data">
                @csrf
      <div class="modal-header">
    ...
    <div class="row mt-5 productlist">
        ...
        <div class="card">
            ...
            <form action="{{route('admin.campaign.update',$campaign->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3 row" id="specific_date" style="display:{{$campaign->length_type == "specific_date" ? '': 'none' }}">
                        <label for="staticEmail" class="col-md-2 col-form-label">@if(Session::has('lang') && Session::get('lang')=='bn') তারিখ @else Date @endif </label>
                        <div class="col-md-4">
                        <input type="date" class="form-control" value="{{$campaign->specific_dates}}" id="staticEmail"  name="specific_date">
                            @error('specific_date')
                                <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
                    ...
                    <div class="row" style="display:{{ $campaign->length_type=="specific_date" ? 'none': '' }}">
                    ...
                    <div class="mb-3 row timerange" @if(empty($campaign->start_time) && empty($campaign->end_time)) style="display: none" @endif>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                        <input type="text" name="discount_amount" value="{{$campaign->discount_amount}}" class="form-control" >
                ...
                <div class="mb-3 row" id="editPro" style="display:{{ $campaign->campaign_type=='product' ? '':'none' }}">
                    ...
                    <div class="col-md-8 col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h6>@if(Session::has('lang') && Session::get('lang')=='bn') পণ্য সম্পাদনা করুন @else Edit Product @endif</h6>
                            </div>
                        <div class=" card-body">
                            <div class="table-responsive" style="max-height:400px;overflow-y:auto;">
                                ...
                                <button type="button" style="float: right;" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#exampleModal">
                ...
                <div class="mb-3 row" id="editCate" style="display:{{ $campaign->campaign_type == 'category' ? '': 'none' }}">
                    ...
                    <div class="col-md-8 col-sm-12">
                        ...
                        <div class="card-header">
                            <h6>
                                @if(Session::has('lang') && Session::get('lang')=='bn') বিভাগ সম্পাদনা করুন @else Edit Category @endif
                            </h6>
                        </div>
                        <div  id="cateEIDpro"  class="card-body">
                            <div class="table-responsive" style="max-height:400px;overflow-y:auto;">
                                ...
                                <button type="button" class="btn btn-info" style="float: right;" data-bs-toggle="modal" data-bs-target="#exampleModal1">
