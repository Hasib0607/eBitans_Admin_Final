                                    ...
                                    @foreach ($category as $cats)
                                        <tr>
                                            <td><input type="checkbox" name="selectedids" id="ids"
                                                    value="{{ $cats->id }}" class="checkSingles"></td>
                                            <?php
                                            if ($cats->parent != '0') {
                                                $ct = DB::table('categories')
                                                    ->where('id', $cats->parent)
                                                    ->first();
                                            }
                                            ?>
                                            <td>{{ $cats->name }} @if (isset($ct))
                                                    ({{ $ct->name }})
                                                @endif
                                            </td>
                                            <?php
    ...
    <main class="main-content position-relative border-radius-lg">
        ...
        <div class="container-fluid mt-4" id="toplist">
            <div class="row">
                ...
                <div class="col-md-6">
                    <ul>
                        <li style="padding:0px;border:0px;"><a href="{{ URL::to('/') }}/promotion/campaign"
                                class="btn btn-primary" style="display:block;border-radius:0px !important">
                                @if (Session::has('lang') && Session::get('lang') == 'bn')
                                    তালিকায় ফিরে যান
                                @else
                                    Back to List
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.campaign.store') }}" method="post"
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-4">
                                        <select id="ddd" name="discount_type" class="form-control"
                                ...
                                <div class="mb-3 row">
                                    <label for="staticEmail" class="col-md-2 col-form-label">
                                        ...
                                        @else
                                            Discount Amount
                                        @endif
                                        (<strong id="discountPercentange" style="color: #ff5733;">৳</strong>)
                                    </label>
                                    <div class="col-md-4">
