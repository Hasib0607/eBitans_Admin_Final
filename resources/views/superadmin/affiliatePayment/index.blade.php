            ...
            <div class="row card">
                <div class="col-lg-6">
                    <form action="{{ route('affiliate.payment.charge') }}" method="POST"
                        ...
                        <input class="form-control bg-light my-2 mx-2" style="width:200px" type="text"
                               id="affiliate_charge_usd"
                               name="affiliate_charge_usd" placeholder="Affiliate Charge USD" value="{{ $charge_usd }}"
                               required>
                        <button class="btn btn-danger m-0" style="margin-left: 10px !important;" type="submit">
                            Charge
                        </button>
                        <small class="text-info" style="margin-left: 10px">Affiliate payment charge</small>
                    </form>
                </div>
            </div>
