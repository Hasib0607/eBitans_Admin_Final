                                    ...
                                    @foreach($users as $user)
                                        ...
                                        <li class="my-2 rounded justify-content-between" style="display: flex">
                                            <div>
                                                ...
                                                <span class="{{ $className }}" style="font-size: 10px;">({{ $user_status ?? "Pending" }})</span>
                                            </div>
                ...
                <div class="col-md-8">
                    ...
                    <div class="modal-content mb-3">
                                ...
                                @foreach($answers as $item)
                                    <div class="form-group">
                                        ...
                                        @if($item->question_type == 'radio')
                                            ...
                                            <div class="div">
                                                <label
                                                    for="question_1_option_1 p-0 m-0">1. {{$item->answer_option_one}}</label><br>
                                                <label
                                                    for="question_1_option_2 p-0 m-0">2. {{$item->answer_option_two}}</label><br>
                                                <label
                                                    for="question_1_option_3 p-0 m-0">3. {{$item->answer_option_three}}</label><br>
                                                <label
                                                    for="question_1_option_4 p-0 m-0">4. {{$item->answer_option_four}}</label><br>
                                            </div>
                                        ...
                                        @else
                                            <textarea name="question_1" id="question_1" cols="30" rows="2"
                                                      ...
                                                      style="resize: none;">{{$item->answer}}</textarea>
                                        @endif
                                    </div>
                        ...
                        <div class="card">
                            ...
                            {{--                                    Affilate Question Answers Result--}}
                            {{--                                @else--}}
                            {{--                                    Affilate question answers result--}}
                            {{--                                @endif--}}
                            {{--                            </div>--}}
                            <div class="card-body d-flex">
                                ...
                                <form action="{{ route('affiliate.user.status') }}" method="post"
                                      enctype="multipart/form-data">
                                    @csrf

                                    <input type="hidden" name="user_id" value= {{$uid}} />
                                    <button name="Approve" value="Approve" class="btn btn-success m-1 filterbuttonss"
                                            type="submit">
                                        @if (Session::has('lang') && Session::get('lang') == 'bn')
                                            Approve
                                        @else
                                    ...
                                    <button name="Hold" value="Hold" class="btn btn-warning m-1 filterbuttonss"
                                            type="submit">
                                        @if (Session::has('lang') && Session::get('lang') == 'bn')
                                            Hold
                                        @else
                                    ...
                                    <button name="Reject" value="Reject" class="btn btn-primary m-1 filterbuttonss"
                                            type="submit">
                                        @if (Session::has('lang') && Session::get('lang') == 'bn')
                                            Reject
                                        @else
