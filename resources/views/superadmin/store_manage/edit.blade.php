            ...
            <div class="row">
                <div class="col-9 mt-4 mb-4">
                    <div class="content-header row">
                        <div class="col-md-6">
                            <h2 class="content-title">@if(Session::has('lang') && Session::get('lang')=='bn') এডিট পণ্য @else Edit Product @endif</h2>
                        </div>
                        ...
                        <form action="{{route('admin.updateproduct',$product->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            @csrf
                                <div class="mb-4">
                                    ...
                                    <input type="text" placeholder="Type here" class="form-control" id="product_name" value="{{$product->name}}" name="product_name">
                                </div>
                                <div class="mb-4">
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="mb-4">
                                            ...
                                            <div class="row gx-2">
                                                <input placeholder="" type="text" class="form-control" value="{{$product->SKU}}" name="SKU">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="mb-4">
                                            ...
                                            <div class="row gx-2">
                                                <input placeholder="$" type="number" class="form-control" value="{{$product->regular_price}}" name="regular_price">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="mb-4">
                                            ...
                                            <input placeholder="" type="number" class="form-control" value="{{$product->cost}}" name="cost">
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="mb-4">
                                            <label class="form-label">@if(Session::has('lang') && Session::get('lang')=='bn') পরিমাণ @else Quantity @endif <span class="req">*</span></label>
                                            <input placeholder="" type="number" class="form-control" value="{{$product->quantity}}" name="quantity">
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        ...
                                        <select class="form-select" name="discount_type">
                                            <option value="fixed" @if($product->discount_type=='fixed') selected @endif> @if(Session::has('lang') && Session::get('lang')=='bn') ফিক্সড @else  Fixed @endif </option>
                                            <option value="percent" @if($product->discount_type=='percent') selected @endif> @if(Session::has('lang') && Session::get('lang')=='bn') পার্সেন্ট @else  Percent @endif </option>
                                            <option value="no_discount" @if($product->discount_type=='no_discount') selected @endif> @if(Session::has('lang') && Session::get('lang')=='bn') নো ডিসকাউন্ট @else  No Discount @endif </option>
                                        </select>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="mb-4">
                                            <label class="form-label">@if(Session::has('lang') && Session::get('lang')=='bn') ডিসকাউন্ট মূল্য @else Discount price @endif</label>
                                            <input placeholder="$" type="number" class="form-control" value="{{$product->promotional_price}}" name="promotional_price">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-4">
                                            ...
                                            <input placeholder="" type="number" class="form-control" value="{{$product->barcode}}" name="barcode">
                                        </div>
                                    </div>
                                </div>
                                <!-- <div class="mb-4">
                                ...
                                <div class="row" id="shipping-div">
                                    <div class="col-lg-6">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" placeholder="kg" class="form-control" id="weight" value="{{$product->weight}}" name="weight">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="mb-4">
                                            <label for="product_name" class="form-label">@if(Session::has('lang') && Session::get('lang')=='bn') বহন খরচ @else Shipping fees @endif</label>
                                            <input type="number" placeholder="$" class="form-control" id="shipping_fee" value="{{$product->shipping_fee}}" name="shipping_fee">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <select class="form-select" name="tax_type">
                                            <option value="fixed" @if($product->tax_type=='fixed') selected @endif> @if(Session::has('lang') && Session::get('lang')=='bn') স্থির @else  Fixed @endif </option>
                                            <option value="percent" @if($product->tax_type=='percent') selected @endif> @if(Session::has('lang') && Session::get('lang')=='bn') শতাংশ @else Percent @endif </option>
                                        </select>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="mb-4">
                                            <label class="form-label">@if(Session::has('lang') && Session::get('lang')=='bn') করের হার @else Tax rate @endif</label>
                                            <input placeholder="$" type="number" class="form-control" value="{{$product->tax_rate}}" name="tax_rate">
                                        </div>
                                    </div>
                                </div>                                
                            <!-- </form> -->
                ...
                <div class="col-lg-3">
                    <div class="card mb-4">
                        <div class="card-header">
                            <h4>@if(Session::has('lang') && Session::get('lang')=='bn') মিডিয়া @else Media @endif</h4>
                        </div>
                        <div class="card-body">
                            <div class="input-upload" style="text-align:center">
                                ...
                                @if($product->images)
                                    ...
                                    <img src="{{URL::to('/')}}/assets/images/product/{{$image}}" style="padding:10px;border:1px solid black;margin-bottom:5px;" width="60px" height="60px" >
                                    <a href="{{URL::to('/')}}/product/removeimage/{{$product->id}}/{{$image}}">X</a>
                                    @endforeach
                                @endif
                                <br>
                        ...
                        <div class="card-body">
                            <div class="row gx-2">
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <?php
                                        $category=DB::table('categories')->where('store_id',$store_id)->where('status','active')->where('parent',0)->get();
                                    ?>
                                    <select class="form-select" name="category" id="category">
                                        <option> @if(Session::has('lang') && Session::get('lang')=='bn') নির্বাচন করুন @else  Select @endif  </option>
                                        @foreach($category as $cat)
                                        @isset($cat)
                                        <option value="{{$cat->id}}" @if($product->category==$cat->id) selected @endif>{{$cat->name}}</option>
                                        @endif
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <select class="form-select" name="subcategory" id="subcategory">
                                        ...
                                        <?php
                                        $subcategory=DB::table('categories')->where('id',$product->subcategory)->where('status','active')->first();
                                        ?>
                                        <option value="{{$subcategory->id ?? '0'}}">{{$subcategory->name ?? "deleted"}}</option>
                                        @endif
                                    </select>
                                </div>
                                <div class="mb-4">
                                    ...
                                    <select class="form-select" name="brand" id="brand">
                                        ...
                                        @isset($brand)
                                        <option value="{{$brand->id}}" @if(isset($product->brand) && $product->brand==$brand->id) selected @endif>{{$brand->name}}</option>
                                        @endif
                                        @endforeach
                                    </select>
                                    @error('brand')
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="form-select" name="supplier" id="supplier">
                                        ...
                                        @isset($supplier)
                                        <option value="{{$supplier->id}}"  @if(isset($product->supplier) && $product->supplier==$supplier->id) selected @endif>{{$supplier->name}}</option>
                                        @endif
                                        @endforeach
                                    </select>
                                    @error('supplier')
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" value="{{$product->tags}}" class="form-control" data-role="tagsinput" name="tagss" style="width:100%;display: block;">
                                </div>
                                <div class="mb-4">
                                    ...
                                    <input type="text" placeholder="Type here" class="form-control" id="product_name" value="{{$product->seo_keywords}}" name="seo">
                                ...
                                <div class="mb-2">
                                    <label for="best_sell" class="form-label">
                                        <input type="checkbox" id="best_sell" name="best_sell" @if($product->best_sell==1) checked @endif>&nbsp;&nbsp;Best Sell</label>
                                ...
                                <div class="mb-2">
                                    <label for="feature" class="form-label">
                                        <input type="checkbox" id="feature" name="feature" @if($product->feature==1) checked @endif>&nbsp;&nbsp;Feature</label>
                ...
                <?php
                $attri=DB::table('veriants')->where('pid',$product->id)->get();
                $attri_color=DB::table('veriants')->where('pid',$product->id)->select('color')->get();
                $attri_unit=DB::table('veriants')->where('pid',$product->id)->where('color',null)->where('size',null)->select('volume')->get();
                $attri_size=DB::table('veriants')->where('pid',$product->id)->where('color',null)->select('size')->get();
                $attri_onlycolor=DB::table('veriants')->where('pid',$product->id)->where('size',null)->select('color')->get();
                $select_sizess=DB::table('veriants')->where('pid',$product->id)->where('color',null)->where('size','!=',null)->get();
                $select_unitsss=DB::table('veriants')->where('pid',$product->id)->where('color',null)->where('size',null)->where('volume','!=',null)->get();
                $select_onlycolor=DB::table('veriants')->where('pid',$product->id)->where('color','!=',null)->where('size',null)->get();
                            ...
                            <div class="card-body">
                                    <div class="row" id="attri-div">
                                        <div class="col-md-2">
                                           <label for="">@if(Session::has('lang') && Session::get('lang')=='bn') ভেরিয়েন্ট টাইপ @else Variantion Type @endif</label>
                                            <select class="form-control" name="att" id="attributes">
                                                ...
                                                <option value="color"  @if(isset($attri_color) && count($attri_color)>0) selected @endif>Color & Size</option>
                                                <option value="onlycolor" @if(isset($select_onlycolor) && count($select_onlycolor)>0) selected @endif>Color</option>
                                                <option value="unit"  @if(isset($select_unitsss) && count($select_unitsss)>0) selected @endif>Unit</option>
                                                <option value="size" @if(isset($select_sizess) && count($select_sizess)>0) selected @endif>Size</option>
                                            </select>
                                        </div>
                                        
                                        <div id="colorrss" class="col-lg-12 mt-3">
                                            <?php
                                                    $attri_colorss=DB::table('veriants')->where('pid',$product->id)->where('color','!=',null)->where('size','!=',null)->get();
                                            ?>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr id="{{$colorsss->id}}">
                                                        <td class="mt-1" style="text-align:center">
                                                            <select name="clor" id="clor" class="form-control" step="any">
                                                                <?php
                                                                $colors=DB::table('colors')->where('store_id',$store_id)->get();
                                                                ?>
                                                                @if(isset($colors))
                                                                @foreach($colors as $cl)
                                                                    <option value="{{$cl->name}}" @if($colorsss->color==$cl->name) selected @endif>{{$cl->name}}</option>
                                                                @endforeach
                                                                @endif
                                                            </select>
                                                        </td>
                                                        <td class="mt-1" style="text-align:center">
                                                             <select name="siz" id="sizs" class="form-control" step="any">
                                                                <?php
                                                                $size=DB::table('sizes')->where('store_id',$store_id)->get();
                                                                ?>
                                                                @if(isset($size))
                                                                @foreach($size as $key=>$sz)
                                                                <option value="{{$sz->name}}" @if($colorsss->size==$sz->name) selected @endif>{{$sz->name}}</option>
                                                                @endforeach
                                                                @endif
                                                             </select>
                                                        </td>
                                                        <td class="mt-1" style="text-align:center"><input type="number" name="qunty" id="qunty" class="form-control" value="{{$colorsss->quantity}}"></td>
                                                        <input type="hidden" name="attriid" id="attriid" value="{{$colorsss->id}}">
                                                        <td class="mt-1" style="text-align:center"><input type="number" name="aditionalprice" id="additionalpricess" class="form-control" value="{{$colorsss->additional_price ?? 0}}"></td>
                                                        <td class="mt-1" style="text-align:center"><a href="javascript:void(0)" class="updateattri" data-bs-toggle="tooltip" data-bs-placement="top" title="Update" ><img src="{{URL::to('/')}}/img/update.png" alt="" width="30px"></a>&nbsp;&nbsp;<a href="javascript:void(0)"  class="deleteattri" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"><img src="{{URL::to('/')}}/img/delete.png" alt="" width="30px"></a></td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
                                        ...
                                        <div id="sizess" class="col-lg-12 mt-3">
                                            <?php
                                                    $attri_sizess=DB::table('veriants')->where('pid',$product->id)->where('color',null)->where('size','!=',null)->get();
                                            ?>
                                                    ...
                                                    <tr>
                                                        <td class="mt-1" style="text-align:center">
                                                             <select name="siz" id="sizs" class="form-control" step="any">
                                                                ...
                                                                @if(isset($size))
                                                                @foreach($size as $key=>$sz)
                                                                <option value="{{$sz->name}}" @if($sizesss->size==$sz->name) selected @endif>{{$sz->name}}</option>
                                                                @endforeach
                                                                @endif
                                                             </select>
                                                        </td>
                                                        <td class="mt-1" style="text-align:center"><input type="number" name="qunty" id="qunty" class="form-control" value="{{$sizesss->quantity}}"></td>
                                                        <input type="hidden" name="attriid" id="attriid" value="{{$sizesss->id}}">
                                                        <td class="mt-1" style="text-align:center"><input type="number" name="aditionalprice" id="additionalpricess" class="form-control" value="{{$sizesss->additional_price ?? 0}}"></td>
                                                        <td class="mt-1" style="text-align:center"><a href="javascript:void(0)"  class="updatesizeattri" data-bs-toggle="tooltip" data-bs-placement="top" title="Update"><img src="{{URL::to('/')}}/img/update.png" alt="" width="30px"></a>&nbsp;&nbsp;<a href="javascript:void(0)" class="deletesizeattri"><img src="{{URL::to('/')}}/img/delete.png" alt="" width="30px"></a></td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
                                        ...
                                        <div id="onlycolors" class="col-lg-12 mt-3">
                                            <?php
                                                    $attri_onlycolor=DB::table('veriants')->where('pid',$product->id)->where('size',null)->where('color','!=',null)->get();
                                            ?>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td style="text-align:center">
                                                             <select name="colorsd" id="color" class="form-control" step="any">
                                                                <?php
                                                                $colors=DB::table('colors')->where('store_id',$store_id)->get();
                                                                ?>
                                                                @if(isset($colors))
                                                                @foreach($colors as $cl)
                                                                    <option value="{{$cl->code}}" @if($cl->code==$colorssss->color) selected @endif>{{$cl->name}}</option>
                                                                @endforeach
                                                                @endif
                                                             </select>
                                                        </td>
                                                        <td style="text-align:center">
                                                            <input type="number" name="qunty" id="qunty" class="form-control" min="0" value="{{$colorssss->quantity}}">
                                                        </td>
                                                        <input type="hidden" name="attriid" id="attriid" value="{{$colorssss->id}}">
                                                        <td style="text-align:center">
                                                            <input type="number" name="aditionalprice" id="additionalpricess" class="form-control" value="{{$colorssss->additional_price}}" min="0">
                                                        </td>
                                                        <td style="text-align:center"><a href="javascript:void(0)"  class="updateonlycolorattri" data-bs-toggle="tooltip" data-bs-placement="top" title="Update"><img src="{{URL::to('/')}}/img/update.png" alt="" width="30px"></a>&nbsp;&nbsp;<a href="javascript:void(0)" class="deleteonlycolorattri"><img src="{{URL::to('/')}}/img/delete.png" alt="" width="30px"></a></td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            ...
                                                            <div class="row" style="margin-top:5px;">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="number" class="form-control" name="quantitysss[]" placeholder="Enter Quantity" min="0" value="0">
                                                                </div>
                                                                <div class="col-md-3">
                                                                <input type="number" class="form-control" name="pricesss[]" placeholder="Enter Price" min="0" value="0">
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <a class="remove-officer-button3 btn btn-danger mt-3">Delete</a>
                                                                        <br>
                                                                    <a class="btn btn-info" onclick="addOnlycolor()">Add new</a>
                                                                </div>
                                                            </div>
                                                    </td>
                                                </tr>
                                        ...
                                        <div id="unittss" class="col-lg-12 mt-3">
                                             <?php
                                                    $attri_unitsss=DB::table('veriants')->where('pid',$product->id)->where('color',null)->where('size',null)->where('volume','!=',null)->get();
                                            ?>
                                            ...
                                            <table class="table table-stripped" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="mt-1" style="text-align:center">
                                                             <input type="number" class="form-control" name="volumess" id="volumess" value="{{$unitssss->volume}}">
                                                        </td>
                                                        <td class="mt-1">
                                                            <select name="unitss" id="unitss" class="form-control" step="any">
                                                                    ...
                                                                    @if(isset($color))
                                                                    @foreach($color as $cl)
                                                                        <option value="{{$cl->name}}" @if($unitssss->unit==$cl->name) selected @endif>{{$cl->name}}</option>
                                                                    @endforeach
                                                                    @endif
                                                                </select>
                                                        </td>
                                                        <td class="mt-1" style="text-align:center"><input type="number" name="qunty" id="qunty" class="form-control" value="{{$unitssss->quantity}}"></td>
                                                        <input type="hidden" name="attriid" id="attriid" value="{{$unitssss->id}}">
                                                        <td class="mt-1" style="text-align:center"><input type="number" name="aditionalprice" id="additionalpricess" class="form-control" value="{{$unitssss->additional_price ?? 0}}"></td>
                                                        <td class="mt-1" style="text-align:center"><a href="javascript:void(0)"  class="updateunitattri" data-bs-toggle="tooltip" data-bs-placement="top" title="Update"><img src="{{URL::to('/')}}/img/update.png" alt="" width="30px"></a>&nbsp;&nbsp;<a href="javascript:void(0)" class="deleteunitattri" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"><img src="{{URL::to('/')}}/img/delete.png" alt="" width="30px"></a></td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
                                                ...
                                                <tr id="new1" style="margin-top:5px;">
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="row" style="margin-top:5px;">
                                                            ...
                                                            <div class="col-md-3 mt-1">
                                                                <input type="number" class="form-control" name="quantitys[]" placeholder="Enter Quantity" value="">
                                                            </div>
                                                            <div class="col-md-3 mt-1">
...
$('.updateattri').on('click',function(){
    ...
    console.log(size);
    console.log(color);
    $.get('/updateattribute',{id:id,quantity:quantity,size:size,color:color,additional_price:additional_price},function(data){
            console.log(data);
...
$('.deleteattri').on('click',function(){
    ...
    console.log(size);
    console.log(color);
    $.get('/deleteattribute',{id:id,quantity:quantity,size:size,color:color,additional_price:additional_price},function(data){
            console.log(data);
...
$('.updatesizeattri').on('click',function(){
    ...
    console.log(quantity);
    console.log(size);
    $.get('/updatesizeattribute',{id:id,quantity:quantity,size:size,additional_price:additional_price},function(data){
            console.log(data);
...
$('.deletesizeattri').on('click',function(){
    ...
    console.log(quantity);
    console.log(size);
    $.get('/deletesizeattribute',{id:id,quantity:quantity,size:size,additional_price:additional_price},function(data){
            console.log(data);
            window.location.reload();
        });
   debugger; 
...
$('.updateonlycolorattri').on('click',function(){
    ...
    console.log(quantity);
    console.log(color);
    $.get('/updateonlycolorattribute',{id:id,quantity:quantity,color:color,additional_price:additional_price},function(data){
            console.log(data);
...
$('.deleteonlycolorattri').on('click',function(){
    ...
    console.log(quantity);
    console.log(color);
    $.get('/deleteonlycolorattribute',{id:id,quantity:quantity,color:color,additional_price:additional_price},function(data){
            console.log(data);
            window.location.reload();
        });
   debugger; 
...
$('.updateunitattri').on('click',function(){
    ...
    console.log(id);
    console.log(quantity);
    $.get('/updateunitattribute',{id:id,quantity:quantity,volume:volume,unit:unit,additional_price:additional_price},function(data){
            console.log(data);
...
$('.deleteunitattri').on('click',function(){
    ...
    console.log(id);
    console.log(quantity);
    $.get('/deleteunitattribute',{id:id,quantity:quantity,volume:volume,unit:unit,additional_price:additional_price},function(data){
            console.log(data);
            window.location.reload();
        });
   debugger; 
