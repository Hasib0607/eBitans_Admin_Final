        ...
        <div class="col-md-12">
            <nav style="--bs-breadcrumb-divider: '';" aria-label="breadcrumb">
                <ol class="breadcrumb" style="background-color:transparent;color:#fff">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('superadmin.pse.index') }}">
    ...
    <div class="row mt-5 productlist">
        ...
        <div class="card">
            ...
            <form action="{{URL::to('category')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="mb-3 row">
                    <label for="staticEmail" class="col-md-2 col-form-label">Name <span class="req">*</span></label>
                    <div class="col-md-4">
                ...
                <div class="mb-3 row">
                    <label for="icon" class="col-md-2 col-form-label">Icon <span class="req">*</span></label>
                    <div class="col-md-4">
                ...
                <div class="mb-3 row">
                    <label for="banner" class="col-md-2 col-form-label">Banner <span class="req">*</span></label>
                    <div class="col-md-4">
                ...
                <div class="mb-3 row">
                    <label for="position" class="col-md-2 col-form-label">Position <span class="req">*</span></label>
                    <div class="col-md-4">
