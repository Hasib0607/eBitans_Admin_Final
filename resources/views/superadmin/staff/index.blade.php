    ...
    <main class="main-content position-relative h-100 border-radius-lg">
        ...
        <div class="container-fluid mt-4" id="toplist">
            <div class="row">
                ...
                <div class="col-md-6">
                    <ul>
                        <li style="padding:0px;border:0px;"><a href="{{route('superadmin.staff.create')}}"
                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-2" style="padding-right:1px;">
                                    <form method="post" action="{{route('superadmin.changestaffsssstatus')}}">
                                        @csrf
                                ...
                                <table class="table" id="taskfilterresult" width="100%">
                                    ...
                                    @foreach($staff as $key => $data)
                                        <tr style="border-bottom:1px solid rgba(0, 0, 0, 0.125)">
                                            <td><input type="checkbox" name="selectedid" value="{{$data->id}}" id="id"
                                            ...
                                            <td>{{$data->phone}}</td>
                                            <td>{{$data->new_commission}}</td>
                                            <td>{{$data->renew_commission}}</td>
                                            <td>{{$data->setup_commission}}</td>
                                            <td>{{$data->created_at}}</td>
                                            <td>
                                                <div class="form-check form-switch" style="text-align:center;">
                                                    <input class="form-check-input switchstatus" type="checkbox"
                                                           data-id="{{$data->id}}" id="flexSwitchCheckChecked"
                                                           @if($data->status=="active") checked=""
                                            ...
                                            <td>
                                                <a href="{{route('superadmin.superstaff.commission',$data->id)}}"
                                                   class="btn btn-primary">View</a>
                                            </td>
                                            <td>
                                                <a href="{{route('superadmin.superstaff.commission.payment.history',$data->id)}}"
                                                   class="btn btn-primary">View</a>
                                            </td>
                                            <td>
                                                <a href="{{route('superadmin.staff.edit',$data->id)}}"><img
                                                        src="{{asset('img/edit.png')}}" width="20px" height="20px"></a>
                                                &nbsp;&nbsp;
                                                <a href="{{route('superadmin.staff.delete',$data->id)}}"
