...
@section('content')
    ...
    <main class="main-content position-relative h-100 border-radius-lg">
        ...
        <section class="container content-main">
            <div class="row">
                <form action="{{route('superadmin.staff.save')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" placeholder="Type here" class="form-control"
                                               id="new_commission"
                                               name="new_commission" value="{{old('new_commission')}}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" placeholder="Type here" class="form-control"
                                               id="renew_commission"
                                               name="renew_commission" value="{{old('renew_commission')}}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" placeholder="Type here" class="form-control"
                                               id="setup_commission"
                                               name="setup_commission" value="{{old('setup_commission')}}">
