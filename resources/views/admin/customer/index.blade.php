                    ...
                    <table class="table table-striped" id="taskfilterresult" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th width="10%">@if(Session::has('lang') && Session::get('lang')=='bn') Auth Types @else Auth Types @endif</th>
                        ...
                        <tbody>
                            ...
                            <tr style="border-bottom:1px solid rgba(0, 0, 0, 0.125)">
                                ...
                                <td>
                                    <img class="zoom border" width="40px" height="40px" src="{{URL::to('/')}}/assets/images/img/{{$customer->image}}" onerror="this.onerror=null;this.src='https://static.thenounproject.com/png/4314581-200.png';" alt="profile">
                                </td>
                                <td>{{$customer->name}}</td>
                                <td>
                                {{$customer->email}}
                                ...
                                <td>
                                    <a href="{{URL::to('/')}}/customer/edit/{{$customer->id}}"><img src="{{asset('img/eye.png')}}" width="20px" height="20px"></a>
                                    &nbsp;&nbsp;
