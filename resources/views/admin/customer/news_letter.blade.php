                    ...
                    <nav style="--bs-breadcrumb-divider: '';" aria-label="breadcrumb">
                        <ol class="breadcrumb" style="background-color:transparent;color:#fff">
                            <li class="breadcrumb-item active">
                                <a href="{{ route('admin.customer.news_latter') }}">
                ...
                <div class="col-md-6">
                    <ul>
                        <li style="padding:0px;border:0px;"><a data-href="/customerexport"
                                onclick="exportTasks(event.target);" style="display:block;border-radius:0px !important"
                            ...
                            <div class="row">
                                <div class="col-md-2" style="padding-right:1px;">
                                    <form id="submitform" method="post"
                                        action="{{ route('admin.customer.news_latter.delete') }}">
                                        @csrf
                                    ...
                                    <tbody>
                                        @foreach ($data as $customer)
                                            <tr style="border-bottom:1px solid rgba(0, 0, 0, 0.125)">
                                                ...
                                                <td>
                                                    <a href={{ route('admin.deletecustomernewsletter', $customer->id) }}"
                                ...
                                <table class="table" width="100%">
                                    @foreach ($data as $key => $customer)
                                        ...
                                        <tr class="cat{{ $key }}" style="display:none">
                                            ...
                                            <td width="60%">
                                                <a href="{{ URL::to('/') }}/customer/edit/{{ $customer->id }}"><img
                                                        src="{{ asset('img/edit.png') }}" width="20px"
                                                        height="20px"></a>
                                                &nbsp;&nbsp;
                                                <a href="{{ URL::to('/') }}/customer/delete/{{ $customer->id }}"
