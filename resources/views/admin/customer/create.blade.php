                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-4">
                                        <label for="product_name"
                                            ...
                                            @endif</label>
                                        <div class="col-md-8">
                                            <input type="text" placeholder="Type here" class="form-control" id="country"
                                                   name="country">
                                            @error('country')
                                            <p class="text-danger" role="alert">{{$message}}</p>
                                            @enderror
                                    ...
                                    <div class="row mb-4">
                                        <label for="product_name"
                                            ...
                                            @endif</label>
                                        <div class="col-md-8">
                                            <input type="text" placeholder="Type here" class="form-control" id="state"
                                                   name="state">
                                            @error('state')
                                            <p class="text-danger" role="alert">{{$message}}</p>
                                            @enderror
                                    ...
                                    <div class="row mb-4">
                                        <label for="product_name"
                                            ...
                                            @endif</label>
                                        <div class="col-md-8">
                                            <input type="text" placeholder="Type here" class="form-control" id="proper"
                                                   name="proper">
                                            @error('proper')
                                            <p class="text-danger" role="alert">{{$message}}</p>
                                            @enderror
