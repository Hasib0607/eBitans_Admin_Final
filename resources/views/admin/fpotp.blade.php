                    ...
                    <div class="card z-index-0 fadeIn3 fadeInBottom">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                                <h4 id="logintop" class="text-white font-weight-bolder text-center mt-2 mb-0">Verify
                                    Otp</h4>
                                <div class="row mt-3">
                        ...
                        <div class="card-body" id="login">
                            ...
                            <form role="form" class="text-start" action="{{ route('submitfpotp') }}" method="POST">
                                ...
                                <div class="text-center">
                                    <button type="submit" id="submitss" class="btn bg-gradient-primary w-100 my-4 mb-2">
                                        Submit
                                    </button>
                                </div>
                                ...
                                @if(session()->has('message'))
                                    <div class="text-center">
                                        <button type="submit" id="" class="btn bg-gradient-primary w-100 my-4 mb-2">
                                            Submit
                                        </button>
                                    </div>
                                @endif
                            ...
                            <input type="hidden" name="start-date" id="now" class="noww"
                ...
                <div class="row align-items-center justify-content-lg-between">
                    <div class="col-12 col-md-6 my-auto">
                        <div class="copyright text-center text-sm text-white text-lg-start">
                            ...
                            All Rights Received |
                            Developed By
                            <a href="https://www.ebitans.com" class="font-weight-bold text-white" target="_blank">eBitans</a>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    var x = setInterval(function () {
        ...
        if (distance < 0) {
            ...
            result = "<a href='{{ (request()->secure() ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'] }}/fpcodeagain?resend=true'>" + text + "</a>";
