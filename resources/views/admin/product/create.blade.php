...
<style>
    ...
    /* IMPORTANT: do not use display: contents here */
    #imgList {
        display: flex;
        flex-wrap: wrap;
        gap: 10px;
...
@push('scripts')
    ...
    <script>
        ...
        {{--    ]--}}
        {{--}--}}
        // CKEDITOR.ClassicEditor.create(document.querySelector(".editor"), CKEditorOption);
    ...
    <script>
        ...
        function ApplyFileValidationRules(readerEvt) {
            ...
            if (CheckFileType(readerEvt.type) == false) {
                ...
                swal.fire(
                    'Error!',
                    "The file (" + readerEvt.name + ") does not match the upload conditions, You can only upload JPG/JPEG/jpg/png/gif/webp/jpeg files",
                    'error'
                );
                // e.preventDefault();
                return false;
                    ...
                    size += `<div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <input type="hidden" class="form-control" onchange="variantImage(event)" accept="image/*" name="cs_Image[` + y + `][]" />
                                    <button type="button"
