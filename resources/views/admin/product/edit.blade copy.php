                ...
                <div class="col-md-12">
                    <nav style="--bs-breadcrumb-divider: '';" aria-label="breadcrumb">
                        <ol class="breadcrumb" style="background-color:transparent;color:#fff">
                            ...
                            @if ((isset($category) && $category == '1') || Auth::user()->type == 'admin' || Auth::user()->type == 'staff')
                            ...
                            @endif
                            @if ((isset($subcategory) && $subcategory == '1') || Auth::user()->type == 'admin' || Auth::user()->type == 'staff')
                                <li class="breadcrumb-item" aria-current="page">
                            ...
                            @endif
                            @if ((isset($attribute) && $attribute == '1') || Auth::user()->type == 'admin' || Auth::user()->type == 'staff')
                                <li class="breadcrumb-item" aria-current="page">
                            ...
                            @endif
                            @if ((isset($brand) && $brand == '1') || Auth::user()->type == 'admin' || Auth::user()->type == 'staff')
                                <li class="breadcrumb-item" aria-current="page">
                                    <a href="{{ URL::to('/') }}/brand">
                            ...
                            @if ((isset($supplier) && $supplier == '1') || Auth::user()->type == 'admin' || Auth::user()->type == 'staff')
                                <li class="breadcrumb-item" aria-current="page">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea hidden placeholder="Type here" class="form-control" id="quill_html" rows="4" name="description">{!! $product->description !!}</textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <label class="form-label">
                                            @if (Session::has('lang') && Session::get('lang') == 'bn') ট্যাক্সের
                                                ধরন
                                            @else
                                                Tax Type @endif
                                        </label>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                                ...
                                                <div class="mb-2">
                                                    <label for="pse" class="form-label">
                                                        <input type="checkbox" id="pse" name="pse" value="1"
                                                            @if ($product->pse == 1 || $product->pse == 2) checked @endif>&nbsp;&nbsp;Request For Product খুঁজো
                                                        @if ($product->pse == 1)
                                ...
                                <div class="col-lg-9">
                                            ...
                                            <div class="row" id="attri-div">
                                                <div class="col-md-2">
                                                    ...
                                                    <select class="form-control" name="att" id="attributes">
                                                        ...
                                                        <option value="color" @if (isset($attri_color) && count($attri_color) > 0) selected @endif>
                                                            Color & Size</option>
                                                        <option value="onlycolor" @if (isset($select_onlycolor) && count($select_onlycolor) > 0) selected @endif>
                                                            Color
                                                        </option>
                                                                ...
                                                                <tbody>
                                                                    @foreach ($attri_colorss as $keyss => $colorsss)
                                                                        <tr id="{{ $colorsss->id }}">
                                                                            ...
                                                                            <td class="mt-1" style="text-align:center">
                                                                                <input type="number"
                                                                                    name="quantitys[{{ $keyss }}][]"
                                                                                    id="qunty" class="form-control"
                                                                ...
                                                                <tbody>
                                                                    @foreach ($attri_sizess as $sizesss)
                                                                        <tr>
                                                                            ...
                                                                            <td class="mt-1" style="text-align:center"><input
                                                                                    type="number" name="quantityss[]" id=""
                                                                                    class="form-control"
                                                                                    value="{{ $sizesss->quantity }}"></td>
                                                                            <input type="hidden" name="attriid" id="attriid"
                                                                                value="{{ $sizesss->id }}">
                                                                            <td class="mt-1" style="text-align:center"><input
                                                                                    type="number" name="pricess[]" id=""
                                                                                    class="form-control"
                                                                ...
                                                                <tbody>
                                                                    @foreach ($attri_unitsss as $unitssss)
                                                                        <tr>
                                                                            ...
                                                                            <td class="mt-1" style="text-align:center">
                                                                                <input type="number" name="Uquantitys[]"
                                    ...
                                    <button class="btn btn-success rounded font-sm hover-up" type="submit" name="update"
                                        value="update">Update</button>
                                    <button class="btn btn-info rounded font-sm hover-up" type="submit">Publish</button>

                                    {{-- store_id, modulus_id --}}
                                    @if (ModulusStatus($store_id, 1))
                                        <button class="btn btn-info rounded font-sm hover-up" style="background:rebeccapurple;"
                                            type="submit" name="duplicate" value="duplicate">Duplicate</button>
                                    @endif
                    ...
                    function addRow(i) {
                        ...
                        sizes.forEach(function(data) {
                            ...
                            size += ` <div class="row" style="margin-top:5px;">
                                                            <div class="col-md-1">
                                                                <input type="checkbox" onclick="checkBox(` + p +
                                `)" id="checkBoxStatus` + p + `" name="sid[` + i + `][]" value="yes">
                                                            </div>
                                                            <div class="col-md-3">
                                ...
                                `" readonly>
                                                            ...
                                                            <div class="col-md-4">
                                                                <input type="number" class="form-control"  id="checkBoxWrite` +
                                p + `" readonly name="quantitys[` + i + `][]" placeholder="Enter Quantity">
                                                            </div>
                                                            <div class="col-md-4">
                                                            <input type="number" class="form-control" name="price[` +
                                i + `][]" placeholder="Enter Price">
                                                            </div>
                                                        </div>`;
                            j++;
