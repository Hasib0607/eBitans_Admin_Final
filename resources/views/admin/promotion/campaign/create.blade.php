                            ...
                            @if (count($products) > 0)
                                @foreach ($products as $product)
                                    @if (isset($product))
                                        <tr>
                                            <td>
                                                <input type="checkbox" name="selectedid" id="id"
                        ...
                        <table class="table table-stripped">
                            ...
                            @if(isset($categories) && count($categories)>0)
                                @foreach($categories as $category)
                                    <tr>
                                        <td>
                                            <input type="checkbox" name="selectedids" id="ids"
                                                   value="{{$category->id}}"
                                                   class="checkSingles">
                                        </td>
    ...
    <main class="main-content position-relative border-radius-lg">
        ...
        <div class="container-fluid mt-4" id="toplist">
            ...
            <div class="row mt-5 productlist">
                <input type="hidden" value="{{$current_currency['symbol']}}" id="symbol">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.campaign.store') }}" method="post"
                                ...
                                <div class="mb-3 row rightmenu" id="repeat_date">
                                    ...
                                    <div class="col-md-4">
                                        <select class="js-example-basic-single form-control" name="repeat_date[]"
                                                multiple="multiple">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-4">
                                        <select id="ddd" name="discount_type" class="form-control discount_type"
                                                onchange="discountPercentangeSelecte()">
                                            <option>
                                                @if (Session::has('lang') && Session::get('lang') == 'bn')
                                                    নির্বাচন করুন
                                                @else
                                ...
                                <div class="mb-3 row" id="discount_input" style="display: none">
                                    <label for="staticEmail" class="col-md-2 col-form-label">
                                        @if (Session::has('lang') && Session::get('lang') == 'bn')
                                            ডিসকাউন্ট মূল্য
                                        @else
                                            Discount Amount
                                        @endif
                                        (<strong id="discountPercentange" style="color: #ff5733;">{{$current_currency->symbol}}</strong>)
                                    </label>
                                    <div class="col-md-4">
                                ...
                                <div class="mb-3 row" id="shipping_area_div" style="display: none">
                                    <label for="staticEmail" class="col-md-2 col-form-label">
                                        @if(Session::has('lang') && Session::get('lang')=='bn')
                                            শিপিং এলাকা
                                        @else
...
@push('scripts')
    ...
    <script>
        function discountPercentangeSelecte() {
