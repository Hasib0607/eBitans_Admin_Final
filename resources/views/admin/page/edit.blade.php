                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="row gx-2">
                                                    <select name="link" class="form-control">
                                                        <option value="none"
                                                            @if ($singleData->link == 'none') selected @endif>None</option>
                                                        <option value="about"
                                                            @if ($singleData->link == 'about') selected @endif>About
                                                        </option>
                                                        <option value="contact"
                                                            @if ($singleData->link == 'contact') selected @endif>Contact
                                                        </option>
                                                        <option value="help"
                                                            @if ($singleData->link == 'help') selected @endif>Help</option>
                                                        <option value="terms_and_condition"
                                                            @if ($singleData->link == 'terms_and_condition') selected @endif>Terms and
                                                            Conditions</option>
                                                        <option value="privacy_policy"
                                                            @if ($singleData->link == 'privacy_policy') selected @endif>Privacy
                                                            Policy</option>
                                                        <option value="return_policy"
                                                            @if ($singleData->link == 'return_policy') selected @endif>Return Policy
                                                        </option>
                                                    </select>
                                                    @error('link')
                                                        <p class="text-danger" role="alert">{{ $message }}</p>
...
@push('scripts')
    ...
    <script>
        ...
        CKEDITOR.ClassicEditor.create(document.getElementById("editor"), {
            ...
            ckfinder: {
                uploadUrl: '{{ route('admin.ckditor') . '?_token=' . csrf_token() }}',
            },
            toolbar: {
                items: [
