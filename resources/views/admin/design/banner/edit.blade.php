                ...
                <div class="col-lg-6" style="margin:0 auto;">
                    <div class="card mb-4">
                        <div class="card-header">
                            <h4>@if(Session::has('lang') && Session::get('lang')=='bn') এডিট ব্যানার @else Edit Banner @endif </h4>
                        </div>
                        <div class="card-body">
                                <div class="mb-4">
                                    <label for="product_name" class="form-label">@if(Session::has('lang') && Session::get('lang')=='bn') ছবি @else Image @endif </label>
                                    <br>
                                    <img src="{{URL::to('/')}}/assets/images/banner/{{$banner->image}}" alt="" width="250px" style="padding:10px;border:1px solid gray;margin-top:5px;margin-bottom:5px;">
                                    <br>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" placeholder="Type here" value="{{$banner->link}}" class="form-control" id="link" name="link">
                                    @error('link')
                                            <p class="text-danger" role="alert">{{$message}}</p>
                                    @enderror
                                </div>
                                <div class="mb-4 row">
                                    ...
                                    <div class="form-check form-switch is-filled" style="text-align:center;padding-top:14px;">
                                        <input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked" name="status" style="margin:0 auto;" @if($banner->status=='active') checked="" @endif>
