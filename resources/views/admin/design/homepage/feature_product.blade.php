    ...
    <main class="main-content position-relative  h-100 border-radius-lg">
        <div class="container-fluid mt-4" id="toplist">
            ...
            <div class="row">
                ...
                @include('admin.design.share.home-page-nav', ['product_feature'=>true])
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <h4> @if(Session::has('lang') && Session::get('lang')=='bn')
                                            সমস্ত বৈশিষ্ট্য পণ্য
                                        @else
                                            All Feature Product
                                        @endif</h4>
                                </div>
                                {{--category filter--}}
                                @include('admin.design.share.home-page-category-filter', ['current_page' => 'feature_product', 'column' => 'feature_product'])
                            </div>
                        </div>

                        {{--home page layout options--}}
                        @include('admin.design.share.home-page-options', ['column'=>'feature_product'])
                    </div>
                </div>
                <!--preview-->
