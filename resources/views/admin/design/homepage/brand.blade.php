    ...
    <main class="main-content position-relative  h-100 border-radius-lg">
        ...
        <div class="container-fluid mt-4" id="toplist">
            <div class="row">
                ...
                @include('admin.design.share.home-page-nav', ['brand'=>true])
                    ...
                    <div class="card h-100">
                        <div class="card-header">
                            <div class="row">
                                ...
                                {{--category filter--}}
                                @include('admin.design.share.home-page-category-filter', ['current_page' => 'brand', 'column' => 'brand'])

                            </div>
                        </div>

                        {{--home page layout options--}}
                        @include('admin.design.share.home-page-options', ['column'=>'brand'])
                    </div>
                </div>
                <!--previews-->
        ...
        $(document).ready(function () {
            $(".changetesti").on("click", function () {
                ...
                $.get($url, {value: value}, function (data) {
                    toastr.success('Brand Design Successfully', 'Success');
                });
            });
        });
    </script>
