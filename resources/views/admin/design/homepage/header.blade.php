    ...
    <main class="main-content position-relative  h-100 border-radius-lg">
        ...
        <div class="container-fluid mt-4" id="toplist">
            <div class="row">
                ...
                @include('admin.design.share.home-page-nav', ['header'=>true])
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                {{--category filter--}}
                                @include('admin.design.share.home-page-category-filter', ['current_page' => 'header', 'column' => 'header'])
                            </div>
                        </div>

                        {{--home page layout options--}}
                        @include('admin.design.share.home-page-options', ['column'=>'header'])
                    </div>
                </div>
