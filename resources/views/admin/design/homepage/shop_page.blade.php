    ...
    <main class="main-content position-relative  h-100 border-radius-lg">
        ...
        <div class="container-fluid mt-4" id="toplist">
            <div class="row">
                ...
                @include('admin.design.share.home-page-nav', ['shop_page'=>true])
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                {{--category filter--}}
                                @include('admin.design.share.home-page-category-filter', ['current_page' => 'shop_page', 'column' => 'shop_page'])
                            </div>
                        </div>

                        {{--home page layout options--}}
                        @include('admin.design.share.home-page-options', ['column'=>'shop_page'])
                    </div>
                </div>
