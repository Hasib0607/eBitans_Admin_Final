    ...
    <div class="row">
        <div class="col-md-3 left-menu card card-body mt-4">
            <ul style="padding-left:0rem;">
                <li  style="margin-bottom:10px;border-radius:10px;cursor:pointer"><a href="{{route('admin.design.homepage.slider')}}" style="display:block">Slider</a></li>
                <li  style="margin-bottom:10px;border-radius:10px;cursor:pointer"><a href="{{route('admin.design.homepage.banner')}}" style="display:block">Banner</a></li>
                <li  style="margin-bottom:10px;border-radius:10px;cursor:pointer"><a href="{{route('admin.design.homepage.banner')}}" style="display:block">Footer Banner </a></li>
                <li  style="margin-bottom:10px;border-radius:10px;cursor:pointer"><a href="{{route('admin.design.homepage.featurecategory')}}" style="display:block">Feature Category</a></li>
                <li  style="margin-bottom:10px;border-radius:10px;cursor:pointer"><a href="{{route('admin.design.homepage.product')}}" style="display:block">Product</a></li>
                <li  style="margin-bottom:10px;border-radius:10px;cursor:pointer"><a href="{{route('admin.design.homepage.featureproduct')}}" style="display:block">Feature Product</a></li>
                <li  style="margin-bottom:10px;border-radius:10px;cursor:pointer"><a href="{{route('admin.design.homepage.bestsellproduct')}}" style="display:block">Best Sell Product</a></li>
                <li  style="margin-bottom:10px;border-radius:10px;cursor:pointer"><a href="{{route('admin.design.homepage.recentaddproduct')}}" style="display:block">New Arrival Product</a></li>
                <li  style="margin-bottom:10px;border-radius:10px;cursor:pointer"><a href="{{route('admin.design.homepage.testimonial')}}" style="display:block">Testimonial</a></li>
                <li  style="margin-bottom:10px;border-radius:10px;cursor:pointer"><a href="{{route('admin.design.homepage.footer')}}" style="display:block">Footer</a></li>
            </ul>
        </div>
        <div class="col-md-9 rightmenu mt-4">
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <form action="{{route('admin.design.homepage.invoicefilter')}}" method="get">
                ...
                @endif
                            <!--<form action="{{route('admin.saveslider')}}" method="post">-->
                                @csrf
                                <?php $header1=DB::table('designs')->where('store_id',$store_id)->where('invoice',null)->first();  ?>
                                <div class="form-group">
                                    <input type="radio" id="Homes" name="invoice" @if(isset($header1)) checked @endif value="null">&nbsp;&nbsp;&nbsp;
                                  ...
                                  <div class="modal-dialog modal-xl">
                                    <div class="modal-content" style="background-color:transparent;border:0px">
                                      ...
                                      <div class="modal-body" style="border:none">
                                        <button class="btn btn-danger sm" onclick="modalRE({{ $key }})" style="float: right; margin: 0px 8px;">X</button>
                                         @if(isset($dsg->image))
                                            <img src="{{URL::to('/')}}/assets/images/design/{{$dsg->image}}"  class="img-fluid" alt="" style="padding:0px 10px;border:0px solid gray;transition-delay: 5s;">
                                            @endif
                                      </div>
                                    </div>
                                  </div>
                                ...
                                <div class="form-group">
                                    <input type="radio" id="Home{{$key}}" name="invoice" class="changeinvoice" @if(isset($header1)) checked @endif value="{{$dsg->value}}">&nbsp;&nbsp;&nbsp;
                                    <label for="Home{{$key}}">
                                        {{$dsg->name}}</label>  &nbsp;&nbsp;&nbsp;
                                        <span data-bs-toggle="modal" data-bs-target="#exampleModal{{$key}}"> <i class="fa fa-eye" aria-hidden="true"></i> </span> &nbsp;&nbsp;&nbsp; @if($key>2) <span><img src="https://img.icons8.com/external-flaticons-flat-flat-icons/34/000000/external-premium-e-commerce-flaticons-flat-flat-icons.png"/></span> @endif
                                </div>
                                @endforeach
                                @endif
    ...
    $(document).ready(function(){
        $(".changeinvoice").on("click",function(){
            ...
            $.get($url,{value:value}, function(data){
               console.log(data);
               toastr.success('Slider Design Successfully', 'Success');
            });
        });
    });
</script>
