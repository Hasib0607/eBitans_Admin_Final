                    ...
                    <table class="table table-striped table-borderless border-0 border-b-2 brc-default-l1">
                        ...
                        @foreach($orderitems as $key=>$oitm)
                            <tr>
                                ...
                                <td>{{$oitm->quantity}}</td>
                                <td class="text-95">৳{{$oitm->price + $oitm->additional_price}}</td>
                                <td class="text-secondary-d2">৳{{$oitm->quantity*($oitm->price  + $oitm->additional_price)}}</td>
                            </tr>
                        @endforeach
                        @endif
                        </tbody>
                            ...
                            <div class="col-12 col-sm-5 text-grey text-90 order-first order-sm-last">
                                ...
                                <div class="row my-2 align-items-center bgc-primary-l3 p-2">
                                    ...
                                    @if (ModulusStatus($store->id, 106))
                                        ...
                                        <div class="col-5">
                                            <span class="text-150 text-success-d3 opacity-2">৳{{$order->paid}}</span>
                                        </div>
                                        <div class="col-7 text-right">
                                            Due Amount
                                        </div>
                                        <div class="col-5">
                                            <span class="text-150 text-success-d3 opacity-2">৳{{$order->due}}</span>
                                        </div>
                                    @endif
