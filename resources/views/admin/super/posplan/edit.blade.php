                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-8">
                                            <input type="number" step="0.01" name="usd_price" id="usd_price"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-8">
                                            <select class="form-control" name="pos_setup" id="pos_setup">
                                                <option value="Yes" @if($data->pos_setup=='Yes') selected @endif>Yes
                                                </option>
                                                <option value="No" @if($data->pos_setup=='No') selected @endif>No
                                                </option>
                                            </select>
                                            @error('pos_setup')
                                            <p class="text-danger" role="alert">{{$message}}</p>
