                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-8">
                                            <input type="number" name="usd_price" id="usd_price" step="0.01"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-8">
                                            <input type="number" name="usd_1_dis" id="usd_1_dis" class="form-control">
                                            @error('usd_1_dis')
                                            <p class="text-danger" role="alert">{{$message}}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-8">
                                            <input type="number" name="usd_6_dis" id="usd_6_dis" class="form-control">
                                            @error('usd_6_dis')
                                            <p class="text-danger" role="alert">{{$message}}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-8">
                                            <input type="number" name="usd_12_dis" id="usd_12_dis"
                                                   class="form-control">
                                            @error('usd_12_dis')
                                            <p class="text-danger" role="alert">{{$message}}</p>
                                            @enderror
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-8">
                                            <input type="number" name="usd_24_dis" id="usd_24_dis"
                                                   class="form-control">
                                            @error('usd_24_dis')
                                            <p class="text-danger" role="alert">{{$message}}</p>
                                            @enderror
