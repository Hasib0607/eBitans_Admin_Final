                            ...
                            <div class="table-responsive">
                                <table class="table" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <th width="19%">Max Upload File</th>
                                    ...
                                    @foreach($plans as $key=>$plan)
                                        <tr>
                                            <td>
                                                <input type="checkbox" name="selectedid" value="{{$plan->id}}" id="id"
                                                       class="checkSingle">
                                            </td>
                                            <td>{{$plan->name}}</td>
                                            <td>{{$plan->price}}</td>
                                            ...
                                            <td>{{$plan->order}}</td>
                                            <td>
                                                <a href="{{route('plan.payment.list', ["type" => "plan", "id" => $plan->id])}}"
                                                   class="btn btn-primary">Edit</a>
                                            </td>
                                            <td>{{$plan->monthly_chat_support ?? 0}}</td>
                                            <td>{{$plan->upload_file_limit ?? 0}}</td>
                                            <td>
