                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-8">
                                            <select class="form-control" name="page_setup" id="page_setup">
                                                <option value="Yes" @if($data->page_setup=='Yes') selected @endif>Yes
                                                </option>
                                                <option value="No" @if($data->page_setup=='No') selected @endif>No
                                                </option>
                                            </select>
                                            @error('page_setup')
                                            <p class="text-danger" role="alert">{{$message}}</p>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-8">
                                            <input type="number" name="static_content" id="static_content"
                                                   class="form-control" value="{{$data->static_content}}">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-8">
                                            <input type="number" name="video_content" id="video_content"
                                                   class="form-control" value="{{$data->video_content}}">
                                            @error('video_content')
                                            <p class="text-danger" role="alert">{{$message}}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-8">
                                            <input type="number" name="gify_content" id="gify_content"
                                                   class="form-control" value="{{$data->gify_content}}">
                                            @error('gify_content')
                                            <p class="text-danger" role="alert">{{$message}}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-8">
                                            <select class="form-control" name="boosting_page" id="boosting_page">
                                                <option value="Yes" @if($data->boosting_page=="Yes") selected @endif>
                                                    Yes
                                                </option>
                                                <option value="No" @if($data->boosting_page=="No") selected @endif>No
                                                </option>
                                            </select>
                                            @error('boosting_page')
                                            <p class="text-danger" role="alert">{{$message}}</p>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-8">
                                            <input type="number" name="caption_writting" id="caption_writting"
                                                   class="form-control" value="{{$data->caption_writting}}">
