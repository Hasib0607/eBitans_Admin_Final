...
@section('content')
    ...
    <div class="container-fluid">
                    ...
                    <div class="card mb-2">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                ...
                                <h4 class="mb-0">{{ $currentWeekVisitors }}</h4>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
                        <div class="card-footer p-3">
                            <p class="mb-0"><span
                                    class="text-success text-sm font-weight-bolder"> {{ $visitorChange }} </span>than
                                last week
                            </p>
                        </div>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 mt-lg-0 mt-4">
                <div class="card ">
                    <div class="card-header p-3 pt-2 bg-transparent">
                        ...
                        <div class="text-end pt-1">
                            <p class="text-sm mb-0 text-capitalize ">Home Traffic</p>
        ...
        {{--                            <div id="map" class="mt-0 mt-lg-n4 jvm-container">--}}
        {{--                                <svg width="776" height="259">--}}
        {{--                                    <defs></defs>--}}
        ...
        <div class="row">
            ...
            {{--                                </div>--}}
            {{--                                <a class="btn btn-sm bg-gradient-secondary mt-4">See all operating system</a>--}}
            {{--                            </div>--}}
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-lg-5 col-12 text-center">
                                <div class="chart">
                                    <canvas id="browserChart" class="chart-canvas" height="200" width="245"
                                            style="display: block; box-sizing: border-box; height: 200px; width: 245.8px;"></canvas>

                                </div>
                                <a class="btn btn-sm bg-gradient-secondary mt-4">See all Browsers</a>
                            </div>
                            <div class="col-lg-7 col-12">
                                <div class="table-responsive">
                                    <table class="table align-items-center mb-0">
                                        ...
                                        @foreach ($browser_infos as $key => $browsers)
                                            <tr>
                                                ...
                                                <td class="align-middle text-center text-sm">
                                                    @php
                                                        $percentage = ($browsers->totalBrowser / $totalUsers) * 100;
                                                    @endphp
                                                    <span
                                                        class="text-xs font-weight-bold"> {{ round($percentage, 2) }} %</span>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-sm font-weight-normal mb-0">
                                                {{ ($url_infos->currentPage() - 1) * $url_infos->perPage() + $loop->iteration }}
                                                . <a href="{{ $url->page_url }}" target="_blank"
                                        ...
                                        <td>
                                            <p class="text-sm font-weight-normal mb-0">{{ $url->total_page_views }}</p>
                                        </td>
                                        <td>
                                            @php
                                                $time = round($url->avg_visit_time, 2);
                                                $time = $time / $url->total_page_views ;
                                                        if($time < 10){
                                                            $time = rand(10,25);
                                                        }
                                            @endphp
...
@push('scripts')
    ...
    <script>
        ...
        const browserData = @json($browser_infos);
        const totalUsers = @json($totalUsers);

        // Calculate percentages
        const percentages = browserData.map(b => {
            return (b.totalBrowser / totalUsers) * 100;
        });
        ...
        new Chart(ctxBrowser, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: percentages,
                    backgroundColor: [
                        '#2152ff', '#3A416F', '#f53939', '#005a14', '#e91e63', '#00c12b', '#96a102'
                    ],
                    weight: 15,
                    cutout: 70,
                    tension: 0.9,
