...
<main class="main-content  mt-0">
    <div class="page-header align-items-start min-vh-100"
         style="background-image: url('{{URL::to('/')}}/ebitans_login (2).jpg');">
                    ...
                    <div class="card z-index-0 fadeIn3 fadeInBottom">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                                <h4 id="logintop" class="text-white font-weight-bolder text-center mt-2 mb-0">Staff Log
                                    In</h4>
                        ...
                        <div class="card-body" id="login">
                            ...
                            <form role="form" class="text-start" action="{{ route('staff.submitlogin') }}"
                                  method="POST">
                                @csrf
                        ...
                        <div class="card-body" id="forget">
                            ...
                            <form role="form" class="text-start" action="{{ route('sendotpfp') }}" method="POST">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn bg-gradient-primary w-100 my-4 mb-2">Send OTP
                                    </button>
                                </div>
                                <p class="mt-4 text-sm text-center">
                                    Back to login?
