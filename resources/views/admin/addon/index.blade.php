...
@section('content')
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        ...
        @include('admin.addon.share.addons-nav', ["mobile_app"=>true])
        ...
        <div class="container-fluid mt-4" id="toplist">
            ...
            <div class="row mt-5 productlist">
                <div class="col-12">
                    ...
                    {{--if having mobile app access--}}
                    @if($view=="Active")
                        <div class="card">
                            <div class="card-header">
                            </div>
                            <div class="card-body">
                                {{--if app request already send--}}
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-10 hh-grayBox pt45 pb20">
                                                <div class="row justify-content-between" style="overflow:hidden">
                                                    <div
                                                        class="order-tracking @if($mobileapp->status=='Request Send') completed @elseif($mobileapp->status=='Payment Verified') completed @elseif($mobileapp->status=='Processing') completed @elseif($mobileapp->status=='Download') completed @endif">
                                                    ...
                                                    <div
                                                        class="order-tracking @if($mobileapp->status=='Payment Verified') completed @elseif($mobileapp->status=='Processing') completed @elseif($mobileapp->status=='Download') completed @endif">
                                                        <span class="is-complete"></span>
                                                    ...
                                                    <div
                                                        class="order-tracking @if($mobileapp->status=='Download') completed @elseif($mobileapp->status=='Processing') completed @endif">
                                                        <span class="is-complete"></span>
                                                        <p>Processing<br>
                                                    ...
                                                    <div
                                                        class="order-tracking @if($mobileapp->status=='Download') completed @endif">
                                                        <span class="is-complete"></span>
                                                        <p>Download App APK<br>
                                                            @if($mobileapp->status=='Download')
                                                                <a href="@if(isset($mobileapp->url)) {{$mobileapp->url}} @else javascript:void(0) @endif"
                                ...
                                @else
                                    {{--create mobile app request--}}
                                    <form action="{{route('admin.savemobileappsinfo',$mobileapp->id)}}" method="post"
                                                ...
                                                <div class="avatar-preview" style="overflow:hidden">
                                                    @if(isset($mobileapp))
                                                        @if(isset($mobileapp->image))
                                                            <img id="output"
                                                                 src="https://admin.ebitans.com/assets/images/category/{{$mobileapp->image}}"
                                                                 style="width:200px;"/>
                                                        @else
                                                            <img id="output" src="http://i.pravatar.cc/500?img=7"
                                                                 style="width:200px;"/>
                    ...
                    @else
                        {{--do not have any mobile app access--}}
                        <div class="card">
                            <div class="card-header"></div>
                            <div class="card-body">
                                <h4 class="text-center">You Don't Have Any Mobile Apps </h4>
                            </div>
                        </div>
                    @endif
