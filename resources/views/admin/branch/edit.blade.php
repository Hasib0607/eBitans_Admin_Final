...
@section('content')
    ...
    <!-- Modal -->
    <div class="modal fade" id="stafffffff" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <form action="{{ route('admin.savestafftobranch') }}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <table class="table table-stripped">
                            ...
                            @endphp
                            @if (count($staffs) > 0)
                                @foreach ($staffs as $key2 => $staff)
                                    @foreach (explode(',', $branch->staff_id) as $key => $item)
                                        @if ($item == $staff->id)
                                            <tr>
                                                <td><input type="checkbox" name="selectedid" checked
                                                           value="{{ $staff->id }}" id="id" class="checkSingle">
                                                </td>
                                                <td>{{ $staff->name }}</td>
                                                <td>{{ $staff->phone }}</td>
                                            </tr>
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-11">
                                                <input type="text" placeholder="Type here"
                                                       value="{{ $branch->name }}" class="form-control" id="name"
                                                       name="name">
                                                @error('name')
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-11">
                                                <input type="email" placeholder="" class="form-control"
                                                       value="{{ $branch->email }}" id="email" name="email">
                                                @error('email')
                                                <p class="text-danger" role="alert">{{ $message }}</p>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-11">
                                                <input type="number" placeholder="Type here" class="form-control"
                                                       value="{{ $branch->phone }}" id="phone" name="phone">
                                                @error('phone')
                                                <p class="text-danger" role="alert">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-11">
                                                <input type="text" placeholder="Type here" class="form-control"
                                                       value="{{ $branch->address }}" id="address" name="address">
                                                @error('address')
                                                <p class="text-danger" role="alert">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6 mt-3">
                                            ...
                                            <div class="col-md-11">
                                                <input type="text" placeholder="Type here" class="form-control"
                                                       value="{{ $branch->tax ?? 0 }}" id="tax" name="tax">
                                                @error('tax')
                                                <p class="text-danger" role="alert">{{ $message }}</p>
                                                @enderror
                                            </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        Staff List<span class="btn" onclick="addstaff()"
                                                        style="text-align: end;right: 10px;position: absolute;cursor: pointer;font-weight: bold;color: blueviolet;">Add
                                            Staff</span>
                                                    ...
                                                    @foreach ($staff as $stf)
                                                        <tr>
                                                            ...
                                                            @if (isset($staffs))
                                                                ...
                                                                <td>{{ $staffs->phone ?? '' }}</td>
                                                                <td>
                                                                    <a href="{{ URL::to('/') }}/removeformbranch/{{ $branch->id }}/{{ $staffs->id }}"
