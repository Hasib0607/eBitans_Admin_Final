...
*/
  ...
  <body>
    ...
    <div class="terminal">
      <h1>যান্ত্রিক ত্রুটি <span class="errorcode">500</span></h1>
      <p class="output">
        প্রিয় গ্রাহক, সাময়িক সময়ের যান্ত্রিক ত্রুটির জন্য আমরা আন্তরিক ভাবে দুঃখিত। দ্রুত সমাধান পেতে যোগাযোগ করেন : +8801886515579
      </p>
      <p class="output">
