                    ...
                    <div class="card z-index-0 fadeIn3 fadeInBottom">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                                <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Verify OTP</h4>
                                <div class="row mt-3">
                        ...
                        <div class="card-body">
                            ...
                            @if (Session::has('send_message'))
                                <div class="alert alert-success" style="color:#fff">
                                    {{ Session::get('send_message') }}</div>
                            @endif
                            <form role="form" class="text-start" action="{{ route('match.code') }}" method="POST">
                                @csrf
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn bg-gradient-primary w-100 my-4 mb-2">Submit OTP
                                    </button>
                                </div>
                                ...
                                <p class="mt-4 text-sm text-center">
                                    Didn't get Otp?
                                    <a href="{{route('getcode')}}" class="text-primary text-gradient font-weight-bold">Click
                                        Here</a> Request for New One
                                </p>
                            </form>
                        </div>
                    </div>
                ...
                <div class="row align-items-center justify-content-lg-between">
                    <div class="col-12 col-md-6 my-auto">
                        <div class="copyright text-center text-sm text-white text-lg-start">
                            ...
                            All Rights Received |
                            Developed By
                            <a href="https://www.ebitans.com.bd" class="font-weight-bold text-white" target="_blank">eBitans</a>
                        </div>
                    </div>
                </div>
            </div>
