                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                                ...
                                <div class="mb-4">
                                    <div class="avatar-upload">
                                        ...
                                        <div class="avatar-preview">
                                            @if(isset($user))
                                            @if(isset($user->image))
                                            <div id="imagePreview" style="background-image: url(https://ebitans.com/assets/images/img/{{$user->image}});">
                                            @else
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" placeholder="Type here" class="form-control" id="name" name="name" value="{{$staff->name ?? old('name')}}">
                                    @error('name')
                                            <p class="text-danger" role="alert">{{$message}}</p>
                                    @enderror
                                </div>
                                <div class="mb-4">
                                    ...
                                    <input type="tel" placeholder="Type here" class="form-control" id="phone" name="phone" value="{{$staff->phone ?? old('phone')}}" readonly>
                                    @error('phone')
                                            <p class="text-danger" role="alert">{{$message}}</p>
                                    @enderror
                                </div>
                                <div class="mb-4">
                                    ...
                                    <input type="email" placeholder="Type here" class="form-control" id="email" name="email" value="{{$staff->email ?? old('email')}}">
                                    @error('email')
                                            <p class="text-danger" role="alert">{{$message}}</p>
                                    @enderror
                                </div>
                                <div class="mb-4">
                                    ...
                                    <input type="text" placeholder="Type here" class="form-control" id="address" name="address" value="{{$staff->address ?? old('address')}}">
                                    @error('address')
                                            <p class="text-danger" role="alert">{{$message}}</p>
                                    @enderror
                                </div>
