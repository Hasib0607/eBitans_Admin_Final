...
<div class="container-fluid mt-4" id="toplist">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <ul>
                <li class="active"><a href="{{route('plans.create')}}">Create New</a></li>
            </ul>
        </div>
    </div>
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-md-2" style="padding-right:1px;">
                        <form method="post" action="{{route('superadmin.changeplansssstatus')}}">
                        @csrf
                    ...
                    <table class="table" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('editplan',$plan->id)}}" class="btn btn-secondary">Edit</a>
                                    <a href="{{route('deleteplan',$plan->id)}}" class="btn btn-danger">Delete</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
