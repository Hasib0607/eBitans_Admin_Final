...
<div class="container-fluid mt-4" id="toplist">
    @if(isset($coupon) && $coupon=='1' || Auth::user()->type=='admin')
    <div class="row">
        <div class="col-md-6">
    ...
    <div class="row mt-5 productlist">
        <div class="col-lg-4 col-md-12 col-sm-12 mt-4">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.savecoupon')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3 row">
                        <label for="staticEmail" class="col-md-11 col-form-label">@if(Session::has('lang') && Session::get('lang')=='bn') নাম @else Name @endif<span class="req">*</span></label>
                        <div class="col-md-11">
                        <input type="text" class="form-control" id="staticEmail" name="name" placeholder="Coupon Name">
                            @error('name')
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-11">
                        <input type="text" class="form-control" id="staticEmail" name="code" placeholder="Coupon code">
                            @error('code')
                                <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
            ...
            <div class="card-header">
                ...
                <div class="row">
                    <div class="col-md-2" style="padding-right:1px;">
                        <form id="submitform" method="post" action="{{route('admin.changecouponstatus')}}">
                        @csrf
                    ...
                    <table class="table table-striped" width="100%" id="taskfilterresult">
                        ...
                        <tbody>
                            ...
                            <tr style="border-bottom:1px solid rgba(0, 0, 0, 0.125)">
                                ...
                                <a href="{{route('admin.coupon.edit',$coupon->id)}}"  ><img src="{{asset('img/edit.png')}}" width="20px" height="20px"></a> &nbsp;&nbsp;
                                <a href="{{route('admin.coupon.delete',$coupon->id)}}" onclick="return confirm('Are you sure you want to delete this item?');"><img src="{{asset('img/delete.png')}}" width="25px" height="25px"></a>               
