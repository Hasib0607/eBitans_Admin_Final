...
<div class="container-fluid mt-4" id="toplist">
    <div class="row">
        <div class="col-md-6">
            <h4>@if(Session::has('lang') && Session::get('lang')=='bn') অফার @else Offer @endif</h4>
        </div>
        <div class="col-md-6">
            <ul>
                <!--<li style="padding:0px;border:0px;"><a href="#" class="btn btn-primary" style="display:block;border-radius:0px !important">Back to List</a></li>-->
    ...
    <div class="row mt-5 productlist">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
            <form @if(isset($offer->id)) action="{{route('admin.offer.update',$offer->id)}}" @else action="{{route('admin.offer.store')}}" @endif method="post" enctype="multipart/form-data">
                @csrf
                <div class="mb-3 row">
                    <label for="staticEmail" class="col-md-2 col-form-label">@if(Session::has('lang') && Session::get('lang')=='bn') নাম @else Name @endif </label>
                    <div class="col-md-4">
                    <input type="text" class="form-control" id="staticEmail" value="{{$offer->name ?? old('name')}}" name="name" placeholder="Offer Name">
                        @error('name')
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                        <input type="date" class="form-control" id="staticEmail" value="{{$offer->start_date ?? old('start_date')}}" name="start_date">
                            @error('start_date')
                                <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                        <input type="date" class="form-control" id="staticEmail" value="{{$offer->end_date ?? old('end_date')}}"  name="end_date">
                            @error('end_date')
                                <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="form-check form-switch is-filled" style="text-align:center;">
                        <input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked" name="status" style="margin:0 auto;" @if(isset($offer)) @if($offer->status=='active')  checked="" @endif @endif>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-8 col-sm-12">
                        <div class="card">
                        <div class="card-header">
                            <button type="button" class="btn btn-primary" id="offersubmit">Delete</button>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive" style="max-height:400px;overflow-y:auto;">
                                <table class="table table-stripped">
                                    ...
                                    <tbody>
                                        <?php
                                        $products=DB::table('products')->where('discount_type','!=','no_discount')->where('store_id',$store_id)->get();
                                        $pp=1;
                                        ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$product->SKU}}</td>
                                            <td>{{$product->regular_price}}</td>
                                            <td><a href="{{URL::to('/')}}/removefromofr/{{$product->id}}" >
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-4">
                        <button type="submit" class="btn btn-info">@if(isset($offer)) @if(Session::has('lang') && Session::get('lang')=='bn') আপডেট @else Update @endif @else @if(Session::has('lang') && Session::get('lang')=='bn') সংরক্ষণ @else Save @endif @endif</button>
                    </div>
                </div>
                </form>
            </div>
