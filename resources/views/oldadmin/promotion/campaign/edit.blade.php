...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
        <form action="{{route('admin.campaign.productupdate',$campaign->id)}}" method="post" enctype="multipart/form-data">
                @csrf
...
<div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
        <form action="{{route('admin.campaign.categoryupdate',$campaign->id)}}" method="post" enctype="multipart/form-data">
                @csrf
      <div class="modal-header">
...
<div class="container-fluid mt-4" id="toplist">
    <div class="row">
        <div class="col-md-6">
            <h4>@if(Session::has('lang') && Session::get('lang')=='bn') প্রচারাভিযান আপডেট করুন @else  Update Campaign @endif</h4>
        </div>
        <div class="col-md-6">
            <ul>
        ...
        <div class="card">
            ...
            <form action="{{route('admin.campaign.update',$campaign->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-4">
                    <input type="text" class="form-control" id="staticEmail" value="{{$campaign->name}}" name="name" placeholder="Campaign Name">
                        @error('name')
                ...
                <div class="mb-3 row">
                    ...
                    <select class="form-control" name="length" id="length">
                        ...
                        <option value="date_range" @if($campaign->length_type=="date_range") selected @endif>@if(Session::has('lang') && Session::get('lang')=='bn') তারিখের পরিসীমা @else Date Range @endif </option>
                        <option value="specific_date" @if($campaign->length_type=="specific_date") selected @endif>@if(Session::has('lang') && Session::get('lang')=='bn') নির্দিষ্ট তারিখ @else Specific Date @endif</option>
                        <!--<option value="repeat_date" @if($campaign->length_type=="repeat_date") selected @endif>Repeat Date</option>-->
                    </select>
                        @error('length')
                            <p class="text-danger">{{$message}}</p>
                        @enderror
                ...
                @if($campaign->length_type=="date_range")
                    <div class="mb-3 row" id="date_range">
                        ...
                        <div class="col-md-4">
                        <input type="date" class="form-control" id="staticEmail" value="{{$campaign->start_date}}" name="start_date">
                            @error('start_date')
                                <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 row" id="date_range1">
                        ...
                        <div class="col-md-4">
                        <input type="date" class="form-control" id="staticEmail" value="{{$campaign->end_date}}" name="end_date">
                            @error('end_date')
                                <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 row" id="specific_date">
                        ...
                        <div class="col-md-4">
                        <input type="text" class="form-control date" value="{{$campaign->specific_dates}}" id="staticEmail"  name="specific_date">
                            @error('specific_date')
                                <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
                    </div>
                    @elseif($campaign->length_type=="repeat_date")
                    <div class="mb-3 row rightmenu" id="repeat_date">
                        ...
                        <?php
                        $date=explode(',',$campaign->repeat_dates);
                        foreach($date as $dt){
                            if($dt=='saturday'){
                                $saturday=1;
                            }elseif($dt=='sunday'){
                        ...
                        ?>
                            <option value="saturday" @if(isset($saturday)) @if($saturday=='1') selected @endif @endif>@if(Session::has('lang') && Session::get('lang')=='bn') শনিবার @else Saturday @endif </option>
                            <option value="sunday" @if(isset($sunday)) @if($sunday=='1') selected @endif @endif>@if(Session::has('lang') && Session::get('lang')=='bn') রবিবার @else Sunday @endif </option>
                            <option value="monday" @if(isset($monday)) @if($monday=='1') selected @endif @endif>@if(Session::has('lang') && Session::get('lang')=='bn') সোমবার @else Monday @endif </option>
                            <option value="tuesday" @if(isset($tuesday)) @if($tuesday=='1') selected @endif @endif>@if(Session::has('lang') && Session::get('lang')=='bn') মঙ্গলবার @else Tuesday @endif </option>
                            <option value="wednesday" @if(isset($wednesday)) @if($wednesday=='1') selected @endif @endif>@if(Session::has('lang') && Session::get('lang')=='bn') বুধবার @else Wednasday @endif </option>
                            <option value="thursday" @if(isset($thursday)) @if($thursday=='1') selected @endif @endif>@if(Session::has('lang') && Session::get('lang')=='bn') বৃহস্পতিবার @else Thursday @endif </option>
                            <option value="friday" @if(isset($friday)) @if($friday=='1') selected @endif @endif>@if(Session::has('lang') && Session::get('lang')=='bn') শুক্রবার @else Friday @endif </option>
                        </select>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                        <input type="checkbox" class="times" name="time" id="time" @if(isset($campaign->start_time) && isset($campaign->end_time)) checked @endif value="1" onchange="valueChanged()">
                            @error('time')
                                <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 row timerange">
                        ...
                        <div class="col-md-4">
                        <input type="time" class="form-control" name="start_time" value="{{$campaign->start_time}}" id="start_time">
                            @error('start_time')
                                <p class="text-danger">{{$message}}</p>
                            @enderror
                        <br>
                        To
                        <br>
                        <input type="time" class="form-control" name="end_time" value="{{$campaign->end_time}}" id="end_time">
                            @error('end_time')
                                <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <select name="discount_type" class="form-control">
                            <option>@if(Session::has('lang') && Session::get('lang')=='bn') নির্বাচন করুন @else Select @endif </option>
                            <option value="fixed" @if($campaign->discount_type=='fixed') selected @endif>@if(Session::has('lang') && Session::get('lang')=='bn') ফিক্সড @else  Fixed @endif </option>
                            <option value="percent" @if($campaign->discount_type=='percent') selected @endif>@if(Session::has('lang') && Session::get('lang')=='bn') পার্সেন্ট @else  Percent @endif </option>
                        </select>
                            @error('discount_type')
                                <p class="text-danger">{{$message}}</p>
                            @enderror
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                        <input type="number" name="discount_amount" value="{{$campaign->discount_amount}}" class="form-control" >
                ...
                <div class="mb-3 row">
                    ...
                    <div class="form-check form-switch is-filled" style="text-align:center;">
                        <input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked" name="status" style="margin:0 auto;" @if($campaign->status=='active')  checked="" @endif>
                ...
                <div class="mb-3 row">
                    ...
                    <select class="form-control" name="campaign_type" id="campaign_type">
                        <option >@if(Session::has('lang') && Session::get('lang')=='bn') নির্বাচন করুন @else Select @endif </option>
                        <option value="product" @if($campaign->campaign_type=='product') selected @endif>@if(Session::has('lang') && Session::get('lang')=='bn') পণ্য @else Product @endif </option>
                        <option value="category" @if($campaign->campaign_type=='category') selected @endif>@if(Session::has('lang') && Session::get('lang')=='bn') বিভাগ @else Category @endif </option>
                    </select>
                    @error('campaign_type')
                            <p class="text-danger" role="alert">{{$message}}</p>
                        @enderror
                ...
                <div class="mb-3 row" @if(isset($campaign->products)) @else style="display:none;" @endif>
                    <label for="position" class="col-md-2 col-form-label">@if(Session::has('lang') && Session::get('lang')=='bn') পণ্য সম্পাদনা করুন @else Edit Product @endif</label>
                    <div class="col-md-4">
                    </div>
                    ...
                    <div class="col-md-8 col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <button type="button" class='btn btn-primary' id="campprodel">Delete</button>
                            </div>
                        <div class=" card-body">
                            <div class="table-responsive" style="max-height:400px;overflow-y:auto;">
                                <table class="table table-stripped">
                                    <thead>
                                        <tr>
                                            <th>
                                                <input type="checkbox" name="idss" id="checkedAllss">
                                            </th>
                                            <th>@if(Session::has('lang') && Session::get('lang')=='bn') নাম @else Name @endif</th>
                                            <th>@if(Session::has('lang') && Session::get('lang')=='bn') এসকেইউ @else SKU @endif</th>
                                            <th>@if(Session::has('lang') && Session::get('lang')=='bn') দাম @else Price @endif</th>
                                            <th>@if(Session::has('lang') && Session::get('lang')=='bn') ডিলিট @else Delete @endif</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @if(isset($campaign->products))
                                        <?php
                                        $p=explode(',',$campaign->products);
                                        ?>
                                        @foreach($p as $pp)
                                        <?php
                                        $product=DB::table('products')->where('id',$pp)->first();
                                        ?>
                                        @if(isset($product))
                                        <tr>
                                            <td>
                                                <input type="checkbox" name="selectedidss" id="idss" value="{{$pp}}" class="checkSingless">
                                            </td>
                                            <td>{{Str::of($product->name)->limit(20)}}</td>
                                            <td>{{$product->SKU}}</td>
                                            <td>{{$product->regular_price}}</td>
                                            <td><a href="{{URL::to('/')}}/removefromcampro/{{$campaign->id}}/{{$pp}}" >
                                                <img src="https://admin.ebitans.com/img/delete.png" width="25px" height="25px">
                                            </a></td>
                                        </tr>
                                        @endif
                                        @endforeach
                ...
                <div class="mb-3 row" @if(isset($campaign->category))  @else style="display:none;" @endif>
                    <label for="position" class="col-md-2 col-form-label">@if(Session::has('lang') && Session::get('lang')=='bn') বিভাগ সম্পাদনা করুন @else Edit Category @endif</label>
                    <div class="col-md-4">
                    </div>
                    ...
                    <div class="col-md-8 col-sm-12">
                        <div class="card">
                        <div class="card-header">
                            <button type="button" class="btn btn-primary" id="deletecatcam">Delete</button>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive" style="max-height:400px;overflow-y:auto;">
                                <table class="table table-stripped">
                                    <thead>
                                        <tr>
                                            <th>
                                                <input type="checkbox" name="idsss" id="checkedAllsss">
                                            </th>
                                            <th>@if(Session::has('lang') && Session::get('lang')=='bn') নাম @else Name @endif</th>
                                            <th>@if(Session::has('lang') && Session::get('lang')=='bn') ডিলিট @else Delete @endif</th>
                                        </tr>
                                    ...
                                    @if(isset($campaign->category))
                                        ...
                                        <?php
                                        $p=explode(',',$campaign->category);
                                        ?>
                                        @if(count($p)>0)
                                        @foreach($p as $pp)
                                        <?php
                                        $product=DB::table('categories')->where('id',$pp)->first();
                                        ?>
                                        @if(isset($product))
                                        <tr>
                                            <td>
                                                <input type="checkbox" name="selectedidsss" id="idsss" value="{{$pp}}" class="checkSinglesss">
                                            </td>
                                            <?php
                                            if($product->parent != "0"){
                                                $ct=DB::table('categories')->where('id',$product->parent)->first();
                                            }
                                            ?>
                                            <td>{{$product->name}} @if(isset($ct)) ({{$ct->name}}) @endif</td>
                                            <td><a href="{{URL::to('/')}}/removefromcamcat/{{$campaign->id}}/{{$pp}}">
                                                <img src="https://admin.ebitans.com/img/delete.png" width="25px" height="25px">
                                            </a></td>
                                        </tr>
                                        @endif
                ...
                <div class="mb-3 row"  @if(isset($campaign->products)) @else id="products" @endif>
                ...
                <div class="mb-3 row" @if(isset($campaign->category)) @else id="categorys" @endif>
