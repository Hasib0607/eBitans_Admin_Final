...
<div class="container-fluid mt-4" id="toplist">
    <div class="row">
        ...
        <div class="col-md-6">
            <ul>
                <li style="padding:0px;border:0px;"><a href="{{route('admin.supplier.index')}}" class="btn btn-primary" style="display:block;border-radius:0px !important">Back to Supplier</a></li>
    ...
    <div class="row mt-5 productlist">
        ...
        <span style="color:#fff">Total Product under {{$supplier->name}} {{count($products) ?? "0" }}</span>
</div>
        </div>
        <div class="col-12">
        <div class="card">
