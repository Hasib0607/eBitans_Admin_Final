...
<div class="container-fluid navbars" style="background-image: linear-gradient(53deg, #42424a 0%, #191919 100%);">
    ...
    <section class="container content-main">
            <div class="row">
            <form action="{{route('admin.updatepage',$singleData->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="col-lg-9 mt-4 mb-4">
                    <div class="content-header row">
                        <div class="col-md-6">
                            <h2 class="content-title">@if(Session::has('lang') && Session::get('lang')=='bn') এডিট পেইজ @else Edit Page @endif </h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-8">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                                ...
                                <div class="row mb-4">
                                    <label for="product_name" class="form-label">@if(Session::has('lang') && Session::get('lang')=='bn') পেজের টাইটেল @else Page title @endif  <span class="req">*</span></label>
                                    <div class="col-md-8">
                                    <input type="text" placeholder="Type here" class="form-control" id="name" value="{{$singleData->name}}" name="name">
                                    @error('name')
                                ...
                                <div class="mb-4">
                                    <label class="form-label">@if(Session::has('lang') && Session::get('lang')=='bn') বিস্তারিত @else Details @endif </label>
                                    <textarea placeholder="Type here" class="form-control" id="editor" rows="8" name="details" >{!! Request::old('details', $singleData->details) !!}</textarea>
                                    @error('details')
                                            <p class="text-danger" role="alert">{{$message}}</p>
                                    @enderror
                                </div>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-4">
                                            <label class="form-label">@if(Session::has('lang') && Session::get('lang')=='bn') লিঙ্ক @else Link @endif <span class="req">*</span></label>
                                            <div class="row gx-2">
                                                <select name="link" class="form-control">
                                                    <option value="none" @if($singleData->link=='none') selected @endif>None</option>
                                                    <option value="about" @if($singleData->link=='about') selected @endif>About</option>
                                                    <option value="help" @if($singleData->link=='help') selected @endif>Help</option>
                                                    <option value="terms_and_condition" @if($singleData->link=='terms_and_condition') selected @endif>Terms and Conditions</option>
                                                    <option value="privacy_policy" @if($singleData->link=='privacy_policy') selected @endif>Privacy Policy</option>
                                                    <option value="return_policy" @if($singleData->link=='return_policy') selected @endif>Return Policy</option>
                                                </select>
                                                @error('link')
                                                    <p class="text-danger" role="alert">{{$message}}</p>
                                                @enderror
                                    ...
                                    <div class="col-lg-8">
                                        <div class="row">
                                            ...
                                            <div class="form-check form-switch is-filled" style="text-align:center;padding-top:14px;">
                                                <input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked" name="status" style="margin:0 auto;" @if($singleData->status=='active') checked="" @endif>
...
<script>
    CKEDITOR.ClassicEditor.create(document.getElementById("editor"), {
        setData( `<?php echo $singleData->details; ?>` );
    }
