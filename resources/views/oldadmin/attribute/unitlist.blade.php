    ...
    <div class="row">
        <div class="col-md-3 left-menu card card-body mt-4">
            <ul style="padding-left:0rem;">
                ...
                <li class="active" style="margin-bottom:10px;border-radius:10px;cursor:pointer"><a href="{{route('admin.attribute.unit')}}" style="display:block;">@if(Session::has('lang') && Session::get('lang')=='bn') ইউনিট @else  Unit @endif</a></li>
            </ul>
        </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-header">
                            <h4>@if(Session::has('lang') && Session::get('lang')=='bn') ইউনিট যোগ করুন @else  Add Unit @endif</h4>
                        </div>
                        <div class="card-body">
                        <form action="{{route('admin.unit.save')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3 row">
                                <label for="staticEmail" class="col-md-4 col-form-label">@if(Session::has('lang') && Session::get('lang')=='bn') নাম @else Name @endif</label>
                                <div class="col-md-12">
                                <input type="text" class="form-control" id="staticEmail" name="name" placeholder="Unit Name" required>
                                    @error('name')
                                ...
                                <table class="table" width="100%" id="taskfilterresult">
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="border-bottom:1px solid rgba(0, 0, 0, 0.125)">
                                            ...
                                            <td>{{$unit->name}}</td>
                                            <td>             
                                                <a href="{{route('admin.unit.delete',$unit->id)}}" style="float:center;margin-right:5px;" onclick="return confirm('Are you sure you want to delete this item?');"><img src="{{asset('img/delete.png')}}" width="25px" height="25px"></a>    
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
