...
<div class="container-fluid mt-4" id="toplist">
    <div class="row">
        <div class="col-md-6">
            <h4>@if(Session::has('lang') && Session::get('lang')=='bn') সমস্ত পর্যালোচনা @else All Review @endif</h4>
        </div>
        <div class="col-md-6">
            <ul>
                <li style="padding:0px;border:0px;"><a data-href="/reviewexport"  onclick="exportTasks(event.target);" style="display:block;border-radius:0px !important" class="btn btn-secondary">@if(Session::has('lang') && Session::get('lang')=='bn') এক্সপোর্ট @else Excel @endif </a></li>
            </ul>
        </div>
    </div>
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-md-2" style="padding-right:1px;">
                        <form id="submitform" method="post" action="{{route('admin.changereviewssstatus')}}">
                        @csrf
                    ...
                    <table class="table table-striped" width="100%" id="taskfilterresult">
                        <thead>
                            <tr>
                                ...
                                <th width="5%">@if(Session::has('lang') && Session::get('lang')=='bn') নাম @else Name @endif</th>
                                <th width="30%">@if(Session::has('lang') && Session::get('lang')=='bn') মন্তব্য @else Comment @endif</th>
                                <th width="10%">@if(Session::has('lang') && Session::get('lang')=='bn') পণ্য আইডি @else Product Id @endif</th>
                                <th width="10%">@if(Session::has('lang') && Session::get('lang')=='bn') অর্ডার আইডি @else Order Id @endif</th>
                                <th width="15%">@if(Session::has('lang') && Session::get('lang')=='bn') তারিখ @else Date @endif</th>
                                <th width="11%">@if(Session::has('lang') && Session::get('lang')=='bn') ডিলিট @else Action @endif</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($reviews as $review)
                            <tr style="border-bottom:1px solid rgba(0, 0, 0, 0.125)">
                                <td><input type="checkbox" name="selectedid" value="{{$review->id}}" id="id" class="checkSingle"></td>
                                <td>{{$review->name}}</td>
                                ...
                                <td>
                                    <a href="{{URL::to('/')}}/review/delete/{{$review->id}}"  onclick="return confirm('Are you sure you want to delete this item?');"><img src="{{asset('img/delete.png')}}" width="25px" height="25px"></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
                ...
                <table class="table-responsive" id="mobiletable">
                    <table class="table" width="100%">
                        ...
                        <tr class="mobilefirstrow">
                            <th width="10%">
                                <input type="checkbox" name="selectedid" value="{{$review->id}}" id="id" class="checkSingle">
                            </th>
