...
<div class="container-fluid navbars" style="background-image: linear-gradient(53deg, #42424a 0%, #191919 100%);">
    ...
    <section class="container content-main">
            <div class="row">
            <form action="{{route('admin.savecustomer')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="col-lg-9 mt-4 mb-4">
                    <div class="content-header row">
                        <div class="col-md-6">
                            <h2 class="content-title">@if(Session::has('lang') && Session::get('lang')=='bn') নতুন ক্রেতা যোগ করুন @else Add New Customer @endif </h2>
                        </div>
                ...
                <div class="col-lg-8">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                                ...
                                <div class="row mb-4">
                                    <label for="product_name" class="form-label">@if(Session::has('lang') && Session::get('lang')=='bn') দেশ @else Country @endif</label>
                                    <div class="col-md-8">
                                    <input type="text" placeholder="Type here" class="form-control" id="country" name="country">
                                    @error('country')
                                            <p class="text-danger" role="alert">{{$message}}</p>
                                    @enderror
                                    </div>
                                ...
                                <div class="row mb-4">
                                    <label for="product_name" class="form-label">@if(Session::has('lang') && Session::get('lang')=='bn') রাষ্ট্র @else State @endif</label>
                                    <div class="col-md-8">
                                    <input type="text" placeholder="Type here" class="form-control" id="state" name="state">
                                    @error('state')
                                            <p class="text-danger" role="alert">{{$message}}</p>
                                    @enderror
                                    </div>
                                ...
                                <div class="row mb-4">
                                    <label for="product_name" class="form-label">@if(Session::has('lang') && Session::get('lang')=='bn') সঠিক @else Proper @endif</label>
                                    <div class="col-md-8">
                                    <input type="text" placeholder="Type here" class="form-control" id="proper" name="proper">
                                    @error('proper')
                                            <p class="text-danger" role="alert">{{$message}}</p>
                                    @enderror
                                    </div>
