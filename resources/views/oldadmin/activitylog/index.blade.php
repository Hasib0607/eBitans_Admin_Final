                ...
                <ol class="breadcrumb" style="background-color:transparent;color:#fff">
                    ...
                    <li class="breadcrumb-item active">
                        <a href="{{URL::to('/')}}/activitylog">
                            <img src="{{URL::to('/')}}/img/icons/log-file.png"> <br> <span class="nav-link-text ms-1">@if(Session::has('lang') && Session::get('lang')=='bn') কার্য বিবরণী @else Activity Log @endif</span>
                        </a>
                    </li>
                </ol>
            </nav>
                    ...
                    <table class="table table-striped" width="100%" id="taskfilterresult">
                        ...
                        <tbody>
                            ...
                            <tr style="border-bottom:1px solid rgba(0, 0, 0, 0.125)">
                                <td><input type="checkbox" name="selectedid" value="{{$singleData->id}}" id="id" class="checkSingle"></td>
