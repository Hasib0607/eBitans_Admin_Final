                            ...
                            <div class="card-body" id="login">
                                ...
                                <form role="form" class="text-start" action="{{ route('changepass') }}"
                                    ...
                                    <div class="input-group input-group-outline my-3">
                                        ...
                                        <input name="password_confirmation" id="newPassCon" type="password" class="form-control"
                                            required>
                    ...
                    <div class="row align-items-center justify-content-lg-between">
                        <div class="col-12 col-md-6 my-auto">
                            <div class="copyright text-center text-sm text-white text-lg-start">
                                ...
                                Developed By
                                <a href="https://www.wavebox.net" class="font-weight-bold text-white"
                                    target="_blank">Wavebox</a>
                            </div>
                        </div>
                    </div>
                </div>
