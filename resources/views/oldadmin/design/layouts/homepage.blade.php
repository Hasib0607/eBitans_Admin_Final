                ...
                @endif
                            <!--<form action="{{route('admin.saveinvoice')}}" method="post">-->
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="Home{{$key}}">@if(isset($dsg->image)) <img src="{{URL::to('/')}}assets/images/design/{{$dsg->image}}" class="img-fluid headerimg" alt="" style="padding:10px;border:1px solid gray;transition-delay: 5s;"> @else {{$dsg->name}} @endif</label>  &nbsp;&nbsp;&nbsp;
                                </div>
                                @endforeach
                                @endif
