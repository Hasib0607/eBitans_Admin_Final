    ...
    <div class="row">
        <div class="col-md-3 left-menu card card-body mt-4">
            <ul style="padding-left:0rem;">
                <li class="active" style="margin-bottom:10px;border-radius:10px;cursor:pointer"><a href="{{route('admin.design.homepage.slider')}}" style="display:block"> @if(Session::has('lang') && Session::get('lang')=='bn') স্লাইডার @else Slider @endif</a></li>
            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <form action="{{route('admin.design.homepage.sliderfilter')}}" method="get">
                ...
                @endif
                            <!--<form action="{{route('admin.saveslider')}}" method="post">-->
                                @csrf
                                <?php $header1=DB::table('designs')->where('store_id',$store_id)->where('hero_slider','null')->first();  ?>
                                <div class="form-group">
                                    <input type="radio" id="Homes" class="changeslider" name="slider" @if(isset($header1)) checked @endif value="null">&nbsp;&nbsp;&nbsp;
                                    <label for="Homes"> None </label>  &nbsp;&nbsp;&nbsp;
                                </div>
                                @if(isset($design) && count($design)>0)
                                @foreach($design as $key=>$dsg)
                                <?php $header1=DB::table('designs')->where('store_id',$store_id)->where('hero_slider',$dsg->value)->first();  ?>
                                <!-- Modal -->
                                ...
                                <div class="form-group">
                                    <input type="radio" id="Home{{$key}}" name="slider" class="changeslider" @if(isset($header1)) checked @endif value="{{$dsg->value}}">&nbsp;&nbsp;&nbsp;
                                    <label for="Home{{$key}}">
                                        {{$dsg->name}}</label>  &nbsp;&nbsp;&nbsp;
...
<script>
    $(document).ready(function(){
        $(".changeslider").on("click",function(){
            $url="/changeslider";
            var value=$(this).val();
            console.log(value);
