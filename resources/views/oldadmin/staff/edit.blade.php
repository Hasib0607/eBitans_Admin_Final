...
<div class="container-fluid navbars" style="background-image: linear-gradient(53deg, #42424a 0%, #191919 100%);">
    ...
    <section class="container content-main">
            <div class="row">
            <form action="{{route('admin.updatestaff',$singleData->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="col-lg-9 mt-4 mb-4">
                    <div class="content-header row">
                        <div class="col-md-6">
                            <h2 class="content-title">@if(Session::has('lang') && Session::get('lang')=='bn') এডিট স্টাফ @else Edit Staff @endif </h2>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-8">
                                    <input type="text" placeholder="Type here" class="form-control" id="name" name="name" value="{{$staff->name ?? ""}}">
                                    @error('name')
                                ...
                                <div class="row mb-4">
                                    <label for="product_name" class="form-label">@if(Session::has('lang') && Session::get('lang')=='bn') ব্যবহারকারীর নাম @else Username @endif <span class="req">*</span></label>
                                    <div class="col-md-8">
                                    <input type="text" placeholder="Type here" class="form-control" id="username" name="username" value="{{$staff->username ?? ""}}">
                                    @error('username')
                                            <p class="text-danger" role="alert">{{$message}}</p>
                                    @enderror
                                    </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-8">
                                    <input type="email" placeholder="Type here" class="form-control" id="email" name="email" value="{{$staff->email ?? ""}}">
                                    @error('email')
                                            <p class="text-danger" role="alert">{{$message}}</p>
                                    @enderror
                                    </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-8">
                                    <input type="number" placeholder="Type here" class="form-control" id="phone" name="phone" value="{{$staff->phone ?? ""}}">
                                    @error('phone')
                                            <p class="text-danger" role="alert">{{$message}}</p>
                                    @enderror
                                    </div>
                                ...
                                <div class="row mb-4">
                                    <label for="product_name" class="form-label">@if(Session::has('lang') && Session::get('lang')=='bn') পাস্ @else Pos @endif </label>
                                    <div class="col-md-8">
                                    <ul style="list-style:none;">
                                        ...
                                        ?>
                                        <li>
                                                <input type="checkbox" name="pos[]" @if(isset($stfs)) checked @endif value="{{$br->id}}">
                                ...
                                <div class="row mb-4">
                                    <label for="product_name" class="form-label">@if(Session::has('lang') && Session::get('lang')=='bn') ভূমিকা আইডি @else Role Id @endif</label>
                                    <div class="col-md-8">
                                    <select class="form-control" name="roleid" id="roleid">
                                        ...
                                        @foreach($role as $rl)
                                        <option value="{{$rl->id}}" @if(isset($singleData->role_id) && $singleData->role_id==$rl->id) selected @endif>{{$rl->name}}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                    @error('roleid')
