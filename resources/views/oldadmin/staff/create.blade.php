...
<div class="container-fluid navbars" style="background-image: linear-gradient(53deg, #42424a 0%, #191919 100%);">
    ...
    <section class="container content-main">
            <div class="row">
            <form action="{{route('admin.savestaff')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="col-lg-9 mt-4 mb-4">
                    <div class="content-header row">
                        <div class="col-md-6">
                            <h2 class="content-title">@if(Session::has('lang') && Session::get('lang')=='bn') নতুন স্টাফ যোগ করুন @else Add New Staff @endif</h2>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-8">
                                    <input type="text" placeholder="Type here" class="form-control" id="username" name="username">
                                    @error('username')
                                            <p class="text-danger" role="alert">{{$message}}</p>
                                    @enderror
                                    </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-8">
                                    <input type="email" placeholder="Type here" class="form-control" id="email" name="email">
                                    @error('email')
                                            <p class="text-danger" role="alert">{{$message}}</p>
                                    @enderror
                                    </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-8">
                                    <input type="number" placeholder="Type here" class="form-control" id="phone" name="phone">
                                    @error('phone')
                                            <p class="text-danger" role="alert">{{$message}}</p>
                                    @enderror
                                    </div>
                                ...
                                <div class="row mb-4">
                                    <label for="product_name" class="form-label">@if(Session::has('lang') && Session::get('lang')=='bn') পাসওয়ার্ড @else Password @endif <span class="req">*</span></label>
                                    <div class="col-md-8">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <ul style="list-style:none;">
                                        ...
                                        @foreach($brnc as $br)
                                        <li>
                                            <input type="checkbox" name="pos[]" value="{{$br->id}}">
                                ...
                                <button type="submit" class="btn btn-info mt-4 ml-3">@if(Session::has('lang') && Session::get('lang')=='bn') প্রকাশ @else Publish @endif </button>
