...
<div class="container-fluid mt-4" id="toplist">
    <div class="row">
        <div class="col-md-6">
            <h4>All Products under {{$brand->name}}</h4>
        </div>
        <div class="col-md-6">
            <ul>
                <li style="padding:0px;border:0px;"><a href="{{route('admin.brand.index')}}" class="btn btn-primary" style="display:block;border-radius:0px !important">Back to Brand</a></li>
                <li style="padding:0px;border:0px"><a href="#" class="btn btn-secondary" style="display:block;border-radius:0px !important" onclick="download_table_as_csv('taskfilterresult');">Excel</a></li>
                <!--<li style="padding:0px;border:0px;"><a href="{{route('admin.addproducts')}}" class="btn btn-primary" style="display:block;border-radius:0px !important">@if(Session::has('lang') && Session::get('lang')=='bn') নতুন পণ্য যোগ করুন @else Add Product @endif</a></li>-->
                <!--<li style="padding:0px;border:0px;"><a data-href="/tasks" onclick="exportTasks(event.target);" style="display:block;border-radius:0px !important" class="btn btn-secondary">@if(Session::has('lang') && Session::get('lang')=='bn') এক্সপোর্ট @else Export @endif</a></li>-->
            </ul>
        </div>
    </div>
    <div class="row mt-5 productlist">
        ...
        <span style="color:#fff">Total Product under {{$brand->name}} {{count($products) ?? "0" }}</span>
</div>
        </div>
        <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <form action="{{route('admin.branddatefilter',$brand->id)}}" method="get">
                    @csrf
                        ...
                        <tbody>
                            ...
                            <tr style="border-bottom:1px solid rgba(0, 0, 0, 0.125)">
                                ...
                                <td>
                                    ...
                                    <div class="barcode">{!! DNS1D::getBarcodeHTML(ucwords($product->barcode), "C128",1.4,22) !!}</div>
                                    @endif
                                </td>
