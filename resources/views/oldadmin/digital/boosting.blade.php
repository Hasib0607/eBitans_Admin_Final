    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <ul>
                ...
                <li style="padding:0px;border:0px;"><a  style="display:block;border-radius:0px !important" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">Boosting Request</a></li>
            </ul>
        </div>
    </div>
