                ...
                <ol class="breadcrumb" style="background-color:transparent;color:#fff">
                    <li class="breadcrumb-item">
                        <a href="{{URL::to('/')}}/digital_marketing">
                            <img src="{{URL::to('/')}}/img/icons/box.png"> <br> <span
                                class="nav-link-text ms-1">@if(Session::has('lang') && Session::get('lang')=='bn') ড্যাশবোর্ড @else Dashboard @endif</span>
                        </a>
                    </li>
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('admin.required.information') }}">
                            <img src="{{URL::to('/')}}/img/icons/box.png"> <br> <span
                                class="nav-link-text ms-1">@if(Session::has('lang') && Session::get('lang')=='bn') প্রয়োজনীয় তথ্য @else Required Information @endif</span>
                        </a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">
                        <a href="{{URL::to('/')}}/content_download">
                            <img src="{{URL::to('/')}}/img/icons/categories.png"> <br><span
                                class="nav-link-text ms-1"> @if(Session::has('lang') && Session::get('lang')=='bn') কনটেন্ট ডাউনলোড@else Content Download @endif  </span>
                        </a>
                    </li>
                    <li class="breadcrumb-item" aria-current="page">
                        <a href="{{route('admin.content_correction')}}">
                            <img src="{{URL::to('/')}}/img/subcategory.png"> <br><span
                                class="nav-link-text ms-1"> @if(Session::has('lang') && Session::get('lang')=='bn') বিষয়বস্তু সংশোধন @else Content Correction @endif </span>
                        </a>
                    </li>
                    {{-- <li class="breadcrumb-item" aria-current="page">
        ...
        <div class="col-md-12 text-center">
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                  <li class="nav-item" role="presentation">
                        <a class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">@if(Session::has('lang') && Session::get('lang')=='bn') স্ট্যাটিক বিষয়বস্তু @else  Static Content @endif</a>
                  </li>
                  <li class="nav-item" role="presentation">
                        <a class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">@if(Session::has('lang') && Session::get('lang')=='bn') ভিডিও সামগ্রী @else Video Content @endif </a>
                  </li>
                  <li class="nav-item" role="presentation">
                        <a class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">@if(Session::has('lang') && Session::get('lang')=='bn') গিফায় কনটেন্ট @else Gify Content @endif </a>
                  </li>
                  <li class="nav-item" role="presentation">
                        <a class="nav-link" id="pills-caption-tab" data-bs-toggle="pill" data-bs-target="#pills-caption" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">@if(Session::has('lang') && Session::get('lang')=='bn') ক্যাপশন লেখা @else Caption Writing @endif</a>
                  </li>
            </ul>
            <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="col-md-3">
                            <div class="card mt-2">
                                <div class="card-header">
                                    <img style="max-height: 217px;min-height: 217px;" src="{{ asset('clientContent/'.$data->details) }}" onerror="this.src='https://ebitans.com/Image/cover/eBitans-logo-mockup4.jpg';" width="100%">
                                </div>
                                ...
                                <div class="card-footer p-1">
                                    <a class="btn btn-info"  href="{{ route('admin.content.file.view', $data->id) }}">Details</a>
                                    ...
                                    <form id="download_Frm{{$data->id}}" action="{{ route('admin.content.file.download') }}" method="post">
                                        @csrf
                                        <input type="hidden" name="pathName" value="{{'clientContent/'.$data->details}}">
                                    </form>
                                </div>
                            </div>
                      </div>
                  ...
                  <div class="tab-pane fade" id="pills-caption" role="tabpanel" aria-labelledby="pills-caption-tab" tabindex="0">
                      <div class="row">
