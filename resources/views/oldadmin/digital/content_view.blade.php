...
<div class="container-fluid mt-4" id="toplist">
    ...
    <div class="row mt-5 productlist">
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    <a style="float: right;" class="btn btn-primary" data-href="/content/download" data-id="{{$products->id}}" onclick="exportTasks(event.target);">Download</a>
                    @else
        ...
        <div class="col-md-6">
            ...
            <textarea name="" id="" cols="30" class="form-control"  rows="10">{{ $products->details }}</textarea>
            @else
            <img src="{{ asset('clientContent/'.$products->details) }}" onerror="this.src='https://ebitans.com/Image/cover/eBitans-logo-mockup4.jpg';" width="100%">
            @endif
        ...
        <div class="col-md-6">
            ...
            <textarea class="form-control" name="" id="" cols="30" rows="10" readonly>{{$products->note}}</textarea>
        </div>
    </div>
    @endif
</div>
