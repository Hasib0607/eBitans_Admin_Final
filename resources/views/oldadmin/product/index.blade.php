...
<div class="container-fluid mt-4" id="toplist">
    ...
    <div class="row">
        <div class="col-md-6">
            <h4>@if(Session::has('lang') && Session::get('lang')=='bn') সব পণ্য  @else All Products @endif</h4>
        </div>
        <div class="col-md-6">
            <ul>
                ...
                <li style="padding:0px;border:0px;"><a data-href="/tasks" onclick="exportTasks(event.target);" style="display:block;border-radius:0px !important" class="btn btn-secondary">@if(Session::has('lang') && Session::get('lang')=='bn') এক্সপোর্ট @else Download Excel @endif</a></li>
                <li style="padding:0px;border:0px;"><a href="#{{route('admin.printbarcode')}}" onclick="event.preventDefault(); document.getElementById('barCodeForm').submit();" style="display:block;border-radius:0px !important" class="btn btn-info">Print Barcode</a></li>
            </ul>
    ...
    <div class="row mt-5 productlist">
        ...
        <span style="color:#fff">@if(Session::has('lang') && Session::get('lang')=='bn') মোট পণ্য @else Total Product add @endif{{count($products) ?? "" }}/{{$limit}}</span>
</div>
        </div>
        <div class="col-12">
        <div class="card">
