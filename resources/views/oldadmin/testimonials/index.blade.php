...
<div class="container-fluid mt-4" id="toplist">
    <div class="row">
        <div class="col-md-6">
            <h4>@if(Session::has('lang') && Session::get('lang')=='bn') সব প্রশংসাপত্র @else All Testimonials @endif </h4>
        </div>
        <div class="col-md-6">
            <ul>
                <li style="padding:0px;border:0px;"><a href="{{route('admin.testimonials.create')}}" class="btn btn-primary" style="display:block;border-radius:0px !important">@if(Session::has('lang') && Session::get('lang')=='bn') নতুন প্রশংসাপত্র যোগ করুন @else Add New Testimonial @endif </a></li>
                <li style="padding:0px;border:0px;"><a data-href="/testimonialexport" onclick="exportTasks(event.target);" style="display:block;border-radius:0px !important" class="btn btn-secondary">@if(Session::has('lang') && Session::get('lang')=='bn') এক্সপোর্ট @else Excel @endif </a></li>
            </ul>
        </div>
    </div>
                    ...
                    <table class="table table-striped testi" id="taskfilterresult" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th width="20%">@if(Session::has('lang') && Session::get('lang')=='bn') পেশা @else Occupation @endif</th>
                                <th width="10%">@if(Session::has('lang') && Session::get('lang')=='bn') স্টেটাস @else Status @endif </th>
                                <th width="5%">@if(Session::has('lang') && Session::get('lang')=='bn') অবস্থান @else Position @endif </th>
                        ...
                        <tbody>
                            ...
                            <tr style="border-bottom:1px solid rgba(0, 0, 0, 0.125)">
                                <td><input type="checkbox" name="selectedid" value="{{$tst->id}}" id="id" class="checkSingle"></td>
                                <td>
                                    <img src="{{URL::to('/')}}/assets/images/testimonials/{{$tst->image}}" width="150" >
                                </td>
                                <td>{{$tst->name}}</td>
                                <td>{{$tst->occupation}}</td>
                                <td>
                                    <div class="form-check form-switch" style="text-align:center;">
                                        <input class="form-check-input switchstatus" type="checkbox" data-id="{{$tst->id}}" id="flexSwitchCheckChecked" @if($tst->status=="active") checked="" @endif style="margin:0 auto;">
                                        <label class="form-check-label" for="flexSwitchCheckChecked"></label>
                                    </div>
                                </td>
                                <td>
                                    <input type="hidden" name="idss" id="id" value="{{$tst->id}}">
                                    <input type="number" name="position" value="{{$tst->position}}" id="position"> </td>
                                <td>
                                    <a href="{{route('admin.testimonials.edit',$tst->id)}}" ><img src="{{asset('img/edit.png')}}" width="20px" height="20px"></a>
                                    &nbsp;&nbsp;
                                    <a href="{{route('admin.testimonials.delete',$tst->id)}}" onclick="return confirm('Are you sure you want to delete this item?');"><img src="{{asset('img/delete.png')}}" width="25px" height="25px"></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
                ...
                <div class="table-responsive" id="mobiletable">
                    <table class="table" width="100%">
                        ...
                        <tr class="mobilefirstrow">
                            <th width="10%">
                                <input type="checkbox" name="selectedid" value="{{$tst->id}}" id="id" class="checkSingle">
                            </th>
                            <th width="20%" style="color:#f1593a">
                                Image
                            </th>
                            <td width="60%" style="color:black">
                                <img src="{{URL::to('/')}}/assets/images/testimonials/{{$tst->image}}" class="zoom" alt="{{$tst->title}}" width="50px" height="50px">
                            </td>
                            <td width="10%">
